...
Usage: python Dependencies/UnicodeBidi/generate_supplementary_bidi.py DerivedBidiClass.txt [--check]
"""
...
def generate(source):
    ...
    lines = [
        "// Generated by generate_supplementary_bidi.py; do not edit.",
...
if __name__ == "__main__":
    ...
    output = Path(__file__).resolve().parent / "supplementarybidi.inl"
