...
WWAudioClass::DRIVER_TYPE_2D WWAudioClass::Open_2D_Device(bool stereo, int bits, int hertz)
{
	...
	while (((type = Open_2D_Device((LPWAVEFORMAT)&wave_format)) == DRIVER2D_ERROR) && (wave_format.wf.nSamplesPerSec >= 11025))
	{
		//
...
bool WWAudioClass::Cache_Buffer(SoundBufferClass *buffer, const char *string_id)
{
	...
	WWASSERT(string_id != NULL);
	if ((buffer != NULL) && (string_id != NULL) && (buffer->Get_Raw_Length() < (U32)(m_MaxCacheSize / 2)))
	{
...
//
////////////////////////////////////////////////////////////////////////////////////////////////
SoundBufferClass *WWAudioClass::Create_Sound_Buffer(
...
//
////////////////////////////////////////////////////////////////////////////////////////////////
Sound3DClass *WWAudioClass::Create_3D_Sound(
		const char *string_id,
		unsigned char *raw_wave_data,
		unsigned long bytes,
		int classid_hint)
...
//
////////////////////////////////////////////////////////////////////////////////////////////////
AudibleSoundClass *WWAudioClass::Create_Sound(int definition_id, RefCountClass *user_obj, uint32 user_data, int classid_hint)
{
...
//
////////////////////////////////////////////////////////////////////////////////////////////////
AudibleSoundClass *WWAudioClass::Create_Sound(
		const char *def_name,
		...
		int classid_hint)
{
	...
	if (sound != NULL)
	{
		...
		{
			WWDEBUG_SAY(
					("Audio Error:  Creating an instant sound %s with an infinite loop count!", sound->Get_Definition()->Get_Name()));
		}
...
void WWAudioClass::Build_3D_Driver_List(void)
{
	...
	if ((Select_3D_Device(DRIVER3D_A3D) == false) && (Select_3D_Device(DRIVER3D_EAX) == false)
			&& (Select_3D_Device(DRIVER3D_D3DSOUND) == false) && (Select_3D_Device(DRIVER3D_DOLBY) == false))
	{
