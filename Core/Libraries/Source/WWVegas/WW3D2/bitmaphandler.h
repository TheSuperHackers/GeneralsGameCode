...
WWINLINE void BitmapHandlerClass::Write_B8G8R8A8(unsigned char *dest_ptr, WW3DFormat dest_format, const unsigned char *argb)
{
	switch (dest_format)
	{
		case WW3D_FORMAT_A8R8G8B8:
		...
		case WW3D_FORMAT_L8:
		{
			...
			unsigned char tmp = (unsigned char)((((unsigned int)argb[0] * (unsigned int)0x1275) + // 0.0721B
																					 ((unsigned int)argb[1] * (unsigned int)0xB725) + // 0.7154G (rounded up so FF, FF,
																																														// FF becomes FF)
...
WWINLINE void BitmapHandlerClass::Write_B8G8R8A8(unsigned char *dest_ptr, WW3DFormat dest_format, const unsigned &argb)
{
