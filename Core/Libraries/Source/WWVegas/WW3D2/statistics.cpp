...
static void Record_Texture_End()
{
	...
	if (record_texture_mode == Debug_Statistics::RECORD_TEXTURE_DETAILS)
	{
		...
		snprintf(
				...
				last_frame_record_count,
				last_frame_texture_change_count);
...
int Debug_Statistics::Get_Record_Procedural_Texture_Size() // Return total procedural textures used during latest frame, in
																													 // bytes
{
	return last_frame_procedural_texture_memory;
}

int Debug_Statistics::Get_Record_Procedural_Texture_Count() // Return total procedural textures used during latest frame, in
																														// bytes
{
