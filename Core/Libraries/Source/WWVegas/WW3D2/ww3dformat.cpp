...
void Get_WW3D_ZFormat_Name(WW3DZFormat format, StringClass &name)
{
	switch (format)
	{
		...
		case WW3D_ZFORMAT_D15S1:
			name = "D15S1";
			break; // 16-bit z-buffer bit depth where 15 bits are reserved for the depth channel and 1 bit is reserved for the
						 // stencil channel.
...
#ifdef _XBOX
		case WW3D_ZFORMAT_LIN_D24S8:
			name = "D24S8LIN";
			break;
		case WW3D_ZFORMAT_LIN_F24S8:
			name = "F24S8LIN";
			break;
		case WW3D_ZFORMAT_LIN_D16:
			name = "D16LIN";
			break;
		case WW3D_ZFORMAT_LIN_F16:
			name = "F16LIN";
			break;
#endif
	}
