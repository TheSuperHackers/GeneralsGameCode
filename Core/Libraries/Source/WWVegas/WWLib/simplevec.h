 ...
 *=============================================================================================*/
template<class T>
inline SimpleVecClass<T>::SimpleVecClass(int size) : Vector(NULL), VectorMax(0)
{
	if (size > 0)
	{
		Resize(size);
 ...
 *=============================================================================================*/
template<class T>
inline SimpleDynVecClass<T>::SimpleDynVecClass(int size) : SimpleVecClass<T>(size), ActiveCount(0)
{
}
