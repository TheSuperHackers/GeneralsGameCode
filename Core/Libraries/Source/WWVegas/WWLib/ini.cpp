 ...
 *=============================================================================================*/
const WideStringClass& INIClass::Get_Wide_String(WideStringClass& new_string, const char* section, const char* entry, const WideChar* defvalue) const
{
	WideChar out[1024];
	char buffer[1024];
 ...
 *=============================================================================================*/
bool INIClass::Put_Wide_String(const char* section, const char* entry, const WideChar* string)
{
