...
**
*************************************************************************/
GridLinkClass::GridLinkClass(GridCullSystemClass *system) : CullLinkClass(system), GridAddress(-1), Prev(NULL), Next(NULL)
{
}
	...
	*/
	...
	while (!done)
	{
		...
		*/
		...
		if ((CellDim[0] < 2.0 * MinCellSize[0]) && (CellDim[1] < 2.0 * MinCellSize[1]) && (CellDim[2] < 2.0 * MinCellSize[2]))
		{
			done = true;
		}
	}
