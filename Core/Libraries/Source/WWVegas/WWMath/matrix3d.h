...
public:
	...
	WWINLINE explicit Matrix3D(const Matrix3x3 &rotation, const Vector3 &position);
	...
	void Transform_Center_Extent_AABox(const Vector3 &center, const Vector3 &extent, Vector3 *set_center, Vector3 *set_extent)
			const;
