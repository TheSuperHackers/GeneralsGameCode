...
static inline void compute_contact_point(ObbCollisionStruct &context, CastResultStruct *result)
{
	...
	result->ContactPoint.X = context.Box0.Center.X + x[0] * context.A[0].X + x[1] * context.A[1].X + x[2] * context.A[2].X;

	result->ContactPoint.Y = context.Box0.Center.Y + x[0] * context.A[0].Y + x[1] * context.A[1].Y + x[2] * context.A[2].Y;

	result->ContactPoint.Z = context.Box0.Center.Z + x[0] * context.A[0].Z + x[1] * context.A[1].Z + x[2] * context.A[2].Z;
