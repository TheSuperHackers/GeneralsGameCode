...
//
/////////////////////////////////////////////////////////////////////
FilenameParameterClass::FilenameParameterClass(StringClass *string) : StringParameterClass(string)
{
	return;
}
...
TextureFilenameParameterClass::TextureFilenameParameterClass(StringClass *string) :
		FilenameParameterClass(string), Show_Alpha(false), Show_Texture(false)
{
}
...
TextureFilenameParameterClass::TextureFilenameParameterClass(const TextureFilenameParameterClass &src) :
		FilenameParameterClass(src), Show_Alpha(false), Show_Texture(false)
{
}
...
//
/////////////////////////////////////////////////////////////////////
AmmoObjDefParameterClass::AmmoObjDefParameterClass(int *id) : GameObjDefParameterClass(id)
{
	return;
}
...
//
/////////////////////////////////////////////////////////////////////
AmmoObjDefParameterClass::AmmoObjDefParameterClass(const AmmoObjDefParameterClass &src) : GameObjDefParameterClass(NULL)
{
	(*this) = src;
	return;
}
...
//
/////////////////////////////////////////////////////////////////////
const ExplosionObjDefParameterClass &ExplosionObjDefParameterClass::operator=(const ExplosionObjDefParameterClass &src)
{
	m_Value = src.m_Value;
	ParameterClass::operator=(src);
	return *this;
...
bool ScriptParameterClass::operator==(const ScriptParameterClass &src)
{
	...
	//	Data valid?
	//
	if ((m_ScriptName != NULL) && (src.m_ScriptName != NULL) && (m_ScriptParams != NULL) && (src.m_ScriptParams != NULL))
	{
		//
...
//
/////////////////////////////////////////////////////////////////////
ScriptListParameterClass::ScriptListParameterClass(const ScriptListParameterClass &src) : m_NameList(NULL), m_ParamList(NULL)
{
	(*this) = src;
	return;
}
