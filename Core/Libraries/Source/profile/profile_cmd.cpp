...
void ProfileCmdInterface::AddResultFunction(
...
bool ProfileCmdInterface::Execute(
    class Debug &dbg,
    const char *cmd,
    CommandMode cmdmode,
    unsigned argn,
    const char *const *argv)
{
    ...
    if (!strcmp(cmd, "result"))
    {
        ...
        else
        {
            ...
            ++numResFunc;
            resFunc =
                (ProfileResultInterface **)ProfileReAllocMemory(resFunc, numResFunc * sizeof(ProfileResultInterface *));
    ...
    if (!strcmp(cmd, "add"))
    {
        ...
        else
        {
            ...
            Profile::PatternListEntry *cur =
                (Profile::PatternListEntry *)ProfileAllocMemory(sizeof(Profile::PatternListEntry));
