...
{
  strlcpy(m_prefix,prefix?prefix:"",sizeof(m_prefix)-1);
  m_radix=radix;
}
...
{
  if (version)
    strlcpy(Instance.m_version,version,sizeof(Instance.m_version)-1);
  if (internalVersion)
    strlcpy(Instance.m_intVersion,internalVersion,sizeof(Instance.m_intVersion)-1);
  if (buildDate)
    strlcpy(Instance.m_buildDate,buildDate,sizeof(Instance.m_buildDate)-1);
}
