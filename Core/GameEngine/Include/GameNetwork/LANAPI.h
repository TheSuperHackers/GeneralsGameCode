...
static const Int m_lanMaxOptionsLength =
    ...
    (8 + (g_lanGameNameLength + 1) * (Int)sizeof(WideChar) + 4 +
     (g_lanPlayerNameLength + 1) * (Int)sizeof(WideChar) +
...
public:
  ...
  virtual void RequestLocations(
      void) = 0; ///< Request everybody to respond with where they are
  virtual void
  ...
  virtual void
  RequestAccept(void) = 0; ///< Indicate we're OK with the game options
  ...
  virtual void
  RequestGameStart(void) = 0; ///< Tell everyone the game is starting
  ...
  virtual void
  RequestGameAnnounce(void) = 0; ///< Sound out current game info if host
                                 //	virtual void RequestSlotList( void ) = 0;
...
public:
  ...
  // Request functions generate network traffic
  virtual void
  RequestLocations(void); ///< Request everybody to respond with where they are
  ...
  //	virtual void RequestSlotList( void );
  /////< Pump out the Slot info.
  virtual void
