...
struct AudioSettings
{
...
#elif RTS_ZEROHOUR
        :
        m_defaultMoneyTransactionVolume(
            0.0f) // Uses zero volume by default because originally the money sounds did not work in Zero Hour
#endif
    {
    }
    ...
    // NOTE: The higher this value is, the lower normal sounds will be! If you specify a sound volume value of 25%, then
    // sounds will play between 75% and 100%, not 100% to 125%!
