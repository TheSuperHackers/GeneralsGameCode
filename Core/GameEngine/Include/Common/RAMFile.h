...
public:
	...
	virtual Bool openFromArchive(File *archiveFile, const AsciiString &filename, Int offset, Int size); ///< copy file data
																																																			///< from the given
																																																			///< file at the given
																																																			///< offset for the
																																																			///< given size.
	virtual Bool copyDataToFile(File *localFile); ///< write the contents of the RAM file to the given local file.  This could
																								///< be REALLY slow.
