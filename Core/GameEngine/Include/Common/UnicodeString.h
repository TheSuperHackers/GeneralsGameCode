...
public:
	...
	*/
	...
	/**
		Return the length, in characters (not bytes!), of the string. Excluding null terminator.
	*/
	int getLength() const;

	/**
		Return the number of bytes used by the string. Excluding null terminator.
	*/
