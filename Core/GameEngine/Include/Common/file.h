...
public:
    ...
    virtual Int write(const void *buffer, Int bytes) = 0; /**< Write the specified number of bytes from the
                                                           *	 memory pointed at by buffer to the file. Returns the number
                                                           *of bytes written. Returns -1 if an error occurred.
                                                           */
    ...
    virtual Int writeFormat(
        ...
        ...) = 0; /**< Write an unterminated formatted wide character string to the file
                   *	 Returns the number of bytes written.
                   *	 Returns -1 if an error occurred.
                   */
    ...
    virtual Int seek(
        Int bytes,
        seekMode mode = CURRENT) = 0; /**< Sets the file position of the next read/write operation. Returns the new file
                                       ...
                                       *  CURRENT: means seek the specified the number of bytes from the current file
                                       * position END: means seek the specified number of bytes back from the end of the file
                                       */
