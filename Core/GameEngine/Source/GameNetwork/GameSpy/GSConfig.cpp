...
public:
	...
	// Pings
	virtual std::list<AsciiString> getPingServers(void) override { return m_pingServers; }
	virtual Int getNumPingRepetitions(void) override { return m_pingReps; }
	virtual Int getPingTimeoutInMs(void) override { return m_pingTimeout; }
	virtual Int getPingCutoffGood( void ) override {	return m_pingCutoffGood; }
	virtual Int getPingCutoffBad( void ) override { return m_pingCutoffBad;	}

	// QM
	virtual std::list<AsciiString> getQMMaps(void) override { return m_qmMaps; }
	virtual Int getQMBotID(void) override { return m_qmBotID; }
	virtual Int getQMChannel(void) override { return m_qmChannel; }
	...
	virtual AsciiString getLeftoverConfig(void) override { return m_leftoverConfig; }
