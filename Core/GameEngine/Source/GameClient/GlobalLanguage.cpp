...
static const FieldParse TheGlobalLanguageDataFieldParseTable[] =
{
    ...
    {"LanguageID", INI::parseInt,	nullptr,	offsetof(GlobalLanguage, m_languageID)},
    {"LanguagePrefix", INI::parseAsciiString,	nullptr,	offsetof(GlobalLanguage, m_languagePrefix)},
#endif
