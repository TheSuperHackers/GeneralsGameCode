...
void	VideoPlayer::init( void )
{
	...
	// an extra license.
	INI ini;
	ini.loadFileDirectory( AsciiString( "Data\\INI\\Default\\Video.ini" ), INI_LOAD_OVERWRITE, NULL );
	ini.loadFileDirectory( AsciiString( "Data\\INI\\Video.ini" ), INI_LOAD_OVERWRITE, NULL );
}
