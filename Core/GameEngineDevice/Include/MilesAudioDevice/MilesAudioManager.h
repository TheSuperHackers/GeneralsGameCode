...
enum PlayingAudioType CPP_11( : Int){ PAT_Sample, PAT_3DSample, PAT_Stream, PAT_INVALID };

enum PlayingStatus CPP_11( : Int){ PS_Playing, PS_Stopped, PS_Paused };

enum PlayingWhich CPP_11( : Int){ PW_Attack, PW_Sound, PW_Decay, PW_INVALID };
