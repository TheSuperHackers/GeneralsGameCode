...
{
public:
	Int init() override;			///<perform any one time initialization and validation
...
protected:
	...
	void reset() override;		///<do any custom resetting necessary to bring W3D in sync.
};
...
public:
	...
	Int init() override;			///<perform any one time initialization and validation
	void reset() override;		///<do any custom resetting necessary to bring W3D in sync.
	Int shutdown() override;			///<release resources used by shader
