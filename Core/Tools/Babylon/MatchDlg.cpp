...
CMatchDlg::CMatchDlg(CWnd *pParent /*=NULL*/) : CDialog(CMatchDlg::IDD, pParent)
{
...
BOOL CMatchDlg::OnInitDialog()
{
	...
	sprintf(buffer, "Resolve umatched text from \"%s\" on line %d", MatchLabel->NameSB(), MatchOriginalText->LineNumber());
