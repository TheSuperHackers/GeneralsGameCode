                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            for (++i7; i7 != userMap.end(); ++i7)
                                                            {
                                                                ...
                                                                double matchFitness1 =
                                                                    computeMatchFitness(i1->first, u1, i7->first, u7);
                                                                double matchFitness2 =
                                                                    computeMatchFitness(i2->first, u2, i7->first, u7);
                                                                double matchFitness3 =
                                                                    computeMatchFitness(i3->first, u3, i7->first, u7);
                                                                double matchFitness4 =
                                                                    computeMatchFitness(i4->first, u4, i7->first, u7);
                                                                double matchFitness5 =
                                                                    computeMatchFitness(i5->first, u5, i7->first, u7);
                                                                double matchFitness6 =
                                                                    computeMatchFitness(i6->first, u6, i7->first, u7);
                                                                MapBitSet tmp = MapSetUnion(u1->maps, u2->maps);
                                                                tmp = MapSetUnion(tmp, u3->maps);
                                                                tmp = MapSetUnion(tmp, u4->maps);
                                                                tmp = MapSetUnion(tmp, u5->maps);
...
bool GeneralsMatcher::handleUserInfo(const char *nick, const std::string &msg)
{
    ...
    while (1)
    {
        ...
        else if (k == "NumPlayers")
        {
            ...
            if (userInfo->numPlayers != 2 && userInfo->numPlayers != 4 && userInfo->numPlayers != 6
                && userInfo->numPlayers != 8)
            {
