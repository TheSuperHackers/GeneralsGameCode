...
typedef enum TextFormatType
{
	...
	TPF_PATH_ELLIPSIS = DT_PATH_ELLIPSIS, // For displayed text, replaces characters in the middle of the string with ellipses
...
public:
	...
	{
		return ((CharSet == SHIFTJIS_CHARSET) || (CharSet == HANGEUL_CHARSET) || (CharSet == CHINESEBIG5_CHARSET));
	}; // [OYO]
