    ...
    TextShadowType shadow) /* = TPF_FULLSHADOW		*/
{
    ...
    //	Msg( __LINE__, __FILE__, "TTFontClass::Print -- rect2 = [%d, %d, %d, %d].", rect.left, rect.top, rect.right,
    //rect.bottom );
    ...
    TextShadowType shadow) /* = TPF_FULLSHADOW		*/
{
    ...
    //	Msg( __LINE__, __FILE__, "TTFontClass::Print -- strlen = %d.", length );
    //	Msg( __LINE__, __FILE__, "TTFontClass::Print -- rect = [%d, %d, %d, %d].", rect.left, rect.top, rect.right,
    //rect.bottom ); 	Msg( __LINE__, __FILE__, "TTFontClass::Print -- rect2 = [%d, %d, %d, %d].", rect.left, rect.top,
            ...
            default:
                ...
                if (LANG_FRE == LanguageID)
                {
                    TTButtonFontPtrSmall =
                        new TTFontClass(hdc, szFile, szFacename, 20, FW_SEMIBOLD, ANSI_CHARSET, 0, 0, 0, FALSE);
                }
                else
                {
                    TTButtonFontPtrSmall =
                        new TTFontClass(hdc, szFile, szFacename, 22, FW_SEMIBOLD, ANSI_CHARSET, 0, 0, 0, FALSE);
                }
