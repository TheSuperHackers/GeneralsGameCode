...
#define gputm(putmdest, putmdata, putmbytes) \
	(((int)(putmbytes) == 4) ? \
			 ...
			 (((int)(putmbytes) == 1) ? \
						...
						(((int)(putmbytes) == 2) ? \
								 ((void)(*((unsigned short *)(putmdest)) = (unsigned short)(bswap((unsigned long)(putmdata)) >> 16))) : \
								 (((int)(putmbytes) == 3) ? \
											((void)(*((unsigned char *)(putmdest) + 2) = (unsigned char)(putmdata)), \
											 (void)(*((unsigned short *)(putmdest)) = (unsigned short)(bswap((unsigned long)(putmdata)) >> 8))) : \
											(void)0))))
	...
	(((int)(putibytes) == 4) ? \
			 ...
			 (((int)(putibytes) == 1) ? \
						...
						(((int)(putibytes) == 2) ? \
								 ...
								 (((int)(putibytes) == 3) ? \
											((void)(*((unsigned short *)(putidest)) = (unsigned short)(putidata)), \
											 (void)(*((unsigned char *)(putidest) + 2) = (unsigned char)((unsigned long)(putidata) >> 16))) : \
											(void)0))))
