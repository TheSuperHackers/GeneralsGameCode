...
void getPathsFromRegistry(void)
{
    ...
    {
        returnValue =
            RegQueryValueEx(handle, GENERALS_REG_KEY_INSTALLPATH, NULL, &type, (unsigned char *)&g_generalsFilename, &size);
    ...
    {
        returnValue =
            RegQueryValueEx(handle, GENERALS_REG_KEY_SERIAL, NULL, &type, (unsigned char *)&g_generalsSerial, &size);
    ...
    {
        returnValue =
            RegQueryValueEx(handle, WOLAPI_REG_KEY_INSTALLPATH, NULL, &type, (unsigned char *)&g_wolapiRegFilename, &size);
    ...
    {
        returnValue =
            RegQueryValueEx(handle, DLL_REG_KEY_LOCATION, NULL, &type, (unsigned char *)&g_wolapiRealFilename, &size);
