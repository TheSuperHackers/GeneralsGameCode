...
static char *_ShaderBlendSettingPresetNames[NUM_SHADER_BLEND_PRESETS + 1] = { "Opaque",
																																							"Add",
																																							"Multiply",
																																							"Multiply and Add",
																																							"Screen",
 ...
 *=============================================================================================*/
GameMtlShaderDlg::GameMtlShaderDlg(HWND parent, IMtlParams *imp, GameMtl *mtl, int pass) : GameMtlFormClass(imp, mtl, pass)
{
