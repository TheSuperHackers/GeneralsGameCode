 ...
 *=============================================================================================*/
GameMtlTextureDlg::GameMtlTextureDlg(HWND parent, IMtlParams *imp, GameMtl *mtl, int pass) : GameMtlFormClass(imp, mtl, pass)
{
...
void GameMtlTextureDlg::ReloadDialog(void)
{
	...
	SendDlgItemMessage(m_hWnd, IDC_STAGE0_ANIM_COMBO, CB_SETCURSEL, TheMtl->Get_Texture_Anim_Type(PassIndex, 0), 0);

	SendDlgItemMessage(m_hWnd, IDC_STAGE1_ANIM_COMBO, CB_SETCURSEL, TheMtl->Get_Texture_Anim_Type(PassIndex, 1), 0);

	SendDlgItemMessage(m_hWnd, IDC_STAGE0_HINT_COMBO, CB_SETCURSEL, TheMtl->Get_Texture_Hint(PassIndex, 0), 0);

	SendDlgItemMessage(m_hWnd, IDC_STAGE1_HINT_COMBO, CB_SETCURSEL, TheMtl->Get_Texture_Hint(PassIndex, 1), 0);
