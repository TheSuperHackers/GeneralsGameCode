...
//
///////////////////////////////////////////////////////////////////////////
VertexRestoreClass::VertexRestoreClass(Mesh *mesh, MeshDeformClass *modifier, MeshDeformModData *mod_data) :
		m_pModifier(modifier), m_pModData(mod_data), m_pMesh(mesh), m_SetIndex(0), m_KeyframeIndex(0)
{
	assert(mesh != NULL);
...
//
///////////////////////////////////////////////////////////////////////////
VertexPositionRestoreClass::VertexPositionRestoreClass(Mesh *mesh, MeshDeformClass *modifier, MeshDeformModData *mod_data) :
...
//
///////////////////////////////////////////////////////////////////////////
VertexColorRestoreClass::VertexColorRestoreClass(Mesh *mesh, MeshDeformClass *modifier, MeshDeformModData *mod_data) :
		VertexRestoreClass(mesh, modifier, mod_data)
{
	//
	//	Make a copy of the vertex positions
