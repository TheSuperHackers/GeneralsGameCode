...
AnimationCompressionSettingsDialogClass::AnimationCompressionSettingsDialogClass(Interface *maxinterface, HWND parent_wnd) :
		MaxInterface(maxinterface), Options(NULL), Wnd(NULL), ParentWnd(parent_wnd)
{
	return;
}
...
{
	int retval =
			::DialogBoxParam(AppInstance, MAKEINTRESOURCE(IDD_ANIMATION_COMPRESSION), ParentWnd, Real_Message_Proc, (LPARAM)this);
	return retval;
}
...
////////////////////////////////////////////////////////////////////////////////////////
BOOL CALLBACK
		AnimationCompressionSettingsDialogClass::Real_Message_Proc(HWND wnd, UINT message, WPARAM wparam, LPARAM lparam)
{
...
//
////////////////////////////////////////////////////////////////////////////////////////
BOOL AnimationCompressionSettingsDialogClass::Message_Proc(UINT message, WPARAM wparam, LPARAM lparam)
{
	BOOL retval = FALSE;
