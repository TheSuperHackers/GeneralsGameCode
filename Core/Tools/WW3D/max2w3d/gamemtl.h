...
#define GAMEMTL_ROLLUP_FLAGS \
	(GAMEMTL_SURFACE_ROLLUP_OPEN | GAMEMTL_DISPLACEMENT_ROLLUP_OPEN | GAMEMTL_PASSCOUNT_ROLLUP_OPEN \
	 | GAMEMTL_PASS0_ROLLUP_OPEN | GAMEMTL_PASS1_ROLLUP_OPEN | GAMEMTL_PASS2_ROLLUP_OPEN | GAMEMTL_PASS3_ROLLUP_OPEN)
