...
BOOL GameMtlDlg::PanelProc(HWND hwndDlg, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    switch (msg)
    {
        case WM_INITDIALOG:
        {
            ...
            OpacitySpin =
                SetupFloatSpinner(hwndDlg, IDC_OPACITY_SPIN, IDC_OPACITY_EDIT, 0.0f, 1.0f, TheMtl->GetOpacity(), 0.01f);
