...
// OnInitDialog
//
BOOL TextureSettingsDialogClass::OnInitDialog()
{
...
//  Load_Texture_Settings
//
void TextureSettingsDialogClass::Load_Texture_Settings()
{
...
// OnOK
//
void TextureSettingsDialogClass::OnOK()
{
...
// OnCancel
//
void TextureSettingsDialogClass::OnCancel()
{
...
// OnAnimationCheck
//
void TextureSettingsDialogClass::OnAnimationCheck()
{
...
// OnDestroy
//
void TextureSettingsDialogClass::OnDestroy()
{
	if (m_hThumbnail != nullptr)
	{
		::DeleteObject(m_hThumbnail);
...
// OnBrowseButton
//
void TextureSettingsDialogClass::OnBrowseButton()
{
...
// Paint_Thumbnail
//
void TextureSettingsDialogClass::Paint_Thumbnail()
{
	// Paint the thumbnail
	if (m_hThumbnail != nullptr)
	{
...
// OnRestore
//
void TextureSettingsDialogClass::OnRestore()
{
...
// OnApply
//
void TextureSettingsDialogClass::OnApply()
{
