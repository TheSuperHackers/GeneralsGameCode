...
EmitterGeneralPropPageClass::EmitterGeneralPropPageClass(EmitterInstanceListClass *pemitter) :
    m_pEmitterList(NULL), m_Parent(NULL), m_bValid(true), m_Lifetime(0), CPropertyPage(EmitterGeneralPropPageClass::IDD)
{
...
BOOL EmitterGeneralPropPageClass::OnApply(void)
{
    ...
    if (m_EmitterName.GetLength() == 0)
    {
        ::MessageBox(
            m_hWnd,
            "Invalid emitter name.  Please enter a new name.",
            "Invalid settings",
