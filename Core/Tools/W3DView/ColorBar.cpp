...
void ColorBarClass::Create_Bitmap(void)
{
	...
	m_hBitmap = ::CreateDIBSection(hscreen_dc, (const BITMAPINFO *)&bitmap_info, DIB_RGB_COLORS, (void **)&m_pBits, NULL, 0L);
...
void ColorBarClass::Load_Key_Frame_BMP(void)
{
	...
	// Create a bitmap that we can access the bits directly of
	m_KeyFrameDIB =
			::CreateDIBSection(hscreen_dc, (const BITMAPINFO *)&bitmap_info, DIB_RGB_COLORS, (void **)&m_pKeyFrameBits, NULL, 0L);
