...
void TextureMgrDialogClass::OnPropagate(void)
{
	...
	if (MessageBox(
					"Warning, this operation will copy the texture settings from the currently selected mesh into all meshes with the "
					"same texture count.  Do you wish to continue?",
					"Texture Propagate",
