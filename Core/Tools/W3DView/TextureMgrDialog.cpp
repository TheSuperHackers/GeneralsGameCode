...
//
void TextureMgrDialogClass::Fill_List_Ctrl_With_Meshes()
{
...
// OnInitDialog
//
BOOL TextureMgrDialogClass::OnInitDialog()
{
...
// OnOK
//
void TextureMgrDialogClass::OnOK()
{
	// Allow the base class to process this message
	CDialog::OnOK();
}
...
// OnCancel
//
void TextureMgrDialogClass::OnCancel()
{
	// Allow the base class to process this message
	CDialog::OnCancel();
}
...
// OnDestroy
//
void TextureMgrDialogClass::OnDestroy()
{
...
// OnBack
//
void TextureMgrDialogClass::OnBack()
{
	// Display the mesh list
	if (m_bContainsMeshes == false)
	{
...
// OnDetails
//
void TextureMgrDialogClass::OnDetails()
{
...
// OnLarge
//
void TextureMgrDialogClass::OnLarge()
{
	LONG style = ::GetWindowLong(m_ListCtrl, GWL_STYLE);
...
// OnList
//
void TextureMgrDialogClass::OnList()
{
	LONG style = ::GetWindowLong(m_ListCtrl, GWL_STYLE);
...
// OnSmall
//
void TextureMgrDialogClass::OnSmall()
{
	LONG style = ::GetWindowLong(m_ListCtrl, GWL_STYLE);
...
//
/////////////////////////////////////////////////////////////////////////////
void TextureMgrDialogClass::OnPropagate()
{
	//
