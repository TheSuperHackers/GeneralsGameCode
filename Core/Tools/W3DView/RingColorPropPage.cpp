...
RingColorPropPageClass::RingColorPropPageClass(RingRenderObjClass *ring) :
		m_RenderObj(ring), m_bValid(true), m_ColorBar(NULL), m_OpacityBar(NULL), CPropertyPage(RingColorPropPageClass::IDD)
{
