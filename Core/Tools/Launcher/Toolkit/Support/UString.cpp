...
UString::UString(const Char *s) : mData(NULL), mCapacity(0)
{
	Copy(s);
}
...
UString::UString(const WChar *ws) : mData(NULL), mCapacity(0)
{
	Copy(ws);
}
...
UString::UString(const UString &s) : mData(NULL), mCapacity(0)
{
	Copy(s);
}
