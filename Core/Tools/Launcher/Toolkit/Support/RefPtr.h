...
public:
	...
	template<typename Derived>
	RefPtr(const RefPtr<Derived> &derived) : RefPtrBase()
	{
		Attach(const_cast<Derived *>(derived.ReferencedObject()));
	}

	RefPtr(const RefPtr<Type> &object) : RefPtrBase() { Attach(const_cast<Type *>(object.ReferencedObject())); }
	...
	RefPtr(Type *object) : RefPtrBase() { Attach(object); }
...
template<typename Type>
class RefPtrConst : public RefPtrBase
{
public:
	RefPtrConst() : RefPtrConst() {}

	template<typename Derived>
	RefPtrConst(const RefPtr<Derived> &derived) : RefPtrBase()
	{
		Attach(derived.ReferencedObject());
	}

	RefPtrConst(const RefPtr<Type> &object) : RefPtrBase() { Attach(const_cast<Type *const>(object.ReferencedObject())); }

	template<typename Derived>
	RefPtrConst(const RefPtrConst<Derived> &derived) : RefPtrBase()
	{
		Attach(derived.ReferencedObject());
	}

	RefPtrConst(const RefPtrConst<Type> &object) : RefPtrBase() { Attach(object.ReferencedObject()); }
	...
	RefPtrConst(const Type *object) : RefPtrBase() { Attach(object); }
