...
LinearOffsetTextureMapperClass::LinearOffsetTextureMapperClass(const LinearOffsetTextureMapperClass &src) :
		ScaleTextureMapperClass(src), UVOffsetDeltaPerMS(src.UVOffsetDeltaPerMS), LastUsedSyncTime(WW3D::Get_Sync_Time())
{
	CurrentUVOffset.X = 0.0f;
	CurrentUVOffset.Y = 0.0f;
}
...
SineLinearOffsetTextureMapperClass::SineLinearOffsetTextureMapperClass(const SineLinearOffsetTextureMapperClass &src) :
		TextureMapperClass(src), LastUsedSyncTime(WW3D::Get_Sync_Time()), UAFP(src.UAFP), VAFP(src.VAFP), CurrentAngle(0.0f)
{
}
...
StepLinearOffsetTextureMapperClass::StepLinearOffsetTextureMapperClass(
		...
		const char *section,
		unsigned int stage) :
		TextureMapperClass(stage), LastUsedSyncTime(WW3D::Get_Sync_Time()), CurrentStep(0.0f, 0.0f)
{
...
ZigZagLinearOffsetTextureMapperClass::ZigZagLinearOffsetTextureMapperClass(
		...
		float period,
		unsigned int stage) :
		TextureMapperClass(stage), LastUsedSyncTime(WW3D::Get_Sync_Time()), Speed(speed), Period(period)
{
}
...
void WSClassicEnvironmentMapperClass::Apply(int uv_array_index)
{
	...
	Matrix3D mat2(mat[0].X, mat[1].X, mat[2].X, 0.0f, mat[0].Y, mat[1].Y, mat[2].Y, 0.0f, mat[0].Z, mat[1].Z, mat[2].Z, 0.0f);
...
RandomTextureMapperClass::RandomTextureMapperClass(float fps, unsigned int stage) :
		TextureMapperClass(stage), FPS(fps), LastUsedSyncTime(WW3D::Get_Sync_Time()), Speed(0.0f, 0.0f)
{
...
RandomTextureMapperClass::RandomTextureMapperClass(const RandomTextureMapperClass &src) :
		TextureMapperClass(src), FPS(src.FPS), LastUsedSyncTime(WW3D::Get_Sync_Time()), Speed(src.Speed)
{
	CurrentAngle = WWMATH_PI * (rand() & 2047) / 1024.0f;
	Center.U = (rand() & 2047) / 2048.0f;
	Center.V = (rand() & 2047) / 2048.0f;
