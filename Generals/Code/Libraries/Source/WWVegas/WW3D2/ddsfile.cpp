		...
		CubeFaceSize(0)
{
	...
	WWASSERT(
			Format == WW3D_FORMAT_DXT1 || Format == WW3D_FORMAT_DXT2 || Format == WW3D_FORMAT_DXT3 || Format == WW3D_FORMAT_DXT4
...
// cube map
const unsigned char *DDSFileClass::Get_CubeMap_Memory_Pointer(unsigned int face, unsigned int level) const
{
