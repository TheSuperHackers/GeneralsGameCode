...
public:
	...
	const char *			Current_Item_Name() override;
...
public:
	...
	bool			Is_Done() override { return Iterator.Is_Done(); }
	const char *	Current_Item_Name() override { return Iterator.Get_Current_Anim()->Get_Name(); }
...
public:
	...
	void					First() override { Node = WW3DAssetManager::Get_Instance()->Font3DDatas.Head(); }
	void					Next() override	{ Node = Node->Next(); }
	bool					Is_Done() override { return Node==nullptr; }
	const char *			Current_Item_Name() override { return Node->Data()->Name; }
