    ...
    unsigned int stencil)
{
  ...
  bool has_stencil =
      (_PresentParameters.AutoDepthStencilFormat == D3DFMT_D15S1 || _PresentParameters.AutoDepthStencilFormat == D3DFMT_D24S8
       || _PresentParameters.AutoDepthStencilFormat == D3DFMT_D24X4S4);
...
{
  WWASSERT(
      render_state.vertex_buffer_type == BUFFER_TYPE_SORTING
...
TextureClass *DX8Wrapper::Create_Render_Target(int width, int height, bool alpha)
{
  ...
  if (alpha)
  {
    ...
    hr = D3DInterface->CheckDeviceFormat(
        D3DADAPTER_DEFAULT,
        WW3D_DEVTYPE,
        mode.Format,
        D3DUSAGE_RENDERTARGET,
