...
void RecorderClass::startRecording(GameDifficulty diff, Int originalGameMode, Int rankPoints, Int maxFPS) {
	...
	m_file->write(s_genrep, sizeof(s_genrep) - 1);
	...
	m_file->write(replayName.str(), (replayName.getLength() * sizeof(WideChar)) + sizeof(WideChar) );
	...
	m_file->write(versionString.str(), (versionString.getLength() * sizeof(WideChar)) + sizeof(WideChar) );
	m_file->write(versionTimeString.str(), (versionTimeString.getLength() * sizeof(WideChar)) + sizeof(WideChar) );
	...
	*/
	...
	m_file->write(theSlotList.str(), theSlotList.getLength() + sizeof(Char));
	...
	m_file->write(&indexString, 2 * sizeof(Char));
