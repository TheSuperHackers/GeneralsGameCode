...
void GameLogic::logicMessageDispatcher(GameMessage *msg, void *userData)
{
  ...
  switch (msgType)
  {
    ...
    case GameMessage::MSG_DOZER_CONSTRUCT_LINE:
    {
      ...
      {
        TheBuildAssistant->buildObjectNow(constructorObject, place, &loc, angle, constructorObject->getControllingPlayer());
      ...
      else
      {
        ...
        TheBuildAssistant
            ->buildObjectLineNow(constructorObject, place, &loc, &locEnd, angle, constructorObject->getControllingPlayer());
