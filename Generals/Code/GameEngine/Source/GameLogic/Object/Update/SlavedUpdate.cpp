...
void SlavedUpdate::doAttackLogic( const Object *target )
{
	...
	if( data->m_attackWanderRange )
	{
		...
		m_guardPointOffset.zero();
		m_guardPointOffset.x += data->m_attackWanderRange * WWMath::CosTrig( randomDirection );
		m_guardPointOffset.y += data->m_attackWanderRange * WWMath::SinTrig( randomDirection );
...
void SlavedUpdate::doScoutLogic( const Coord3D *mastersDestination )
{
	...
	if( data->m_scoutWanderRange )
	{
		...
		Real randomDirection = GameLogicRandomValue( 0, 2*PI );
		m_guardPointOffset.zero();
		m_guardPointOffset.x += data->m_scoutWanderRange * WWMath::CosTrig( randomDirection );
		m_guardPointOffset.y += data->m_scoutWanderRange * WWMath::SinTrig( randomDirection );
...
void SlavedUpdate::doGuardLogic( Coord3D *pinnedPosition )
{
	...
	if( data->m_guardWanderRange )
	{
		...
		Real randomDirection = GameLogicRandomValue( 0, 2*PI );
		m_guardPointOffset.zero();
		m_guardPointOffset.x += data->m_guardMaxRange * WWMath::CosTrig( randomDirection );
		m_guardPointOffset.y += data->m_guardMaxRange * WWMath::SinTrig( randomDirection );
...
void SlavedUpdate::moveToNewRepairSpot()
{
	...
	if( data->m_repairRange )
	{
		...
		m_guardPointOffset.x += data->m_repairRange * WWMath::CosTrig( randomDirection );
		m_guardPointOffset.y += data->m_repairRange * WWMath::SinTrig( randomDirection );
