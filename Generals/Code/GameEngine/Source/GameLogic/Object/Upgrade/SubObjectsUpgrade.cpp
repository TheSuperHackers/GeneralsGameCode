...
void SubObjectsUpgradeModuleData::buildFieldParse(MultiIniFieldParse &p)
{
	...
	static const FieldParse dataFieldParse[] = { { "ShowSubObjects",
...
void SubObjectsUpgrade::upgradeImplementation()
{
	...
	if (draw)
	{
		...
		for (subObjectName = data->m_showSubObjectNames.begin(); subObjectName != data->m_showSubObjectNames.end();
				 ++subObjectName)
		{
		...
		for (subObjectName = data->m_hideSubObjectNames.begin(); subObjectName != data->m_hideSubObjectNames.end();
				 ++subObjectName)
		{
