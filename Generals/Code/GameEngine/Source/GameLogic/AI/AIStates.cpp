...
Bool AIAttackApproachTargetState::computePath()
{
    ...
    if (getMachineGoalObject())
    {
        ...
        if (ai->isBlockedAndStuck())
        {
            ...
            CRCDEBUG_LOG(
                ("AIAttackApproachTargetState::computePath - requestPath() for object %d", getMachineOwner()->getID()));
            ai->requestPath(&m_goalPosition, getAdjustsDestination());
        }
        else
        {
            ...
            CRCDEBUG_LOG(
                ("AIAttackApproachTargetState::computePath - requestAttackPath() for object %d",
                 getMachineOwner()->getID()));
