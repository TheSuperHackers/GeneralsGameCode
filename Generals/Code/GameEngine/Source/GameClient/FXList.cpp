...
class SoundFXNugget : public FXNugget
{
  ...
  {
    static const FieldParse myFieldParse[] = { { "Name", INI::parseAsciiString, NULL, offsetof(SoundFXNugget, m_soundName) },
                                               { 0, 0, 0, 0 } };
...
class ViewShakeFXNugget : public FXNugget
{
  ...
  static void parse(INI *ini, void *instance, void * /*store*/, const void * /*userData*/)
  {
    static const FieldParse myFieldParse[] = { { "Type", parseShakeType, NULL, offsetof(ViewShakeFXNugget, m_shake) },
                                               { 0, 0, 0, 0 } };
  ...
  {
    static const LookupListRec shakeTypeNames[] = { { "SUBTLE", View::SHAKE_SUBTLE },
...
class TerrainScorchFXNugget : public FXNugget
{
  ...
  static void parse(INI *ini, void *instance, void * /*store*/, const void * /*userData*/)
  {
    static const FieldParse myFieldParse[] = { { "Type", parseScorchType, NULL, offsetof(TerrainScorchFXNugget, m_scorch) },
  ...
  {
    static const LookupListRec scorchTypeNames[] = { { "SCORCH_1", SCORCH_1 },
                                                     { "SCORCH_2", SCORCH_2 },
                                                     { "SCORCH_3", SCORCH_3 },
                                                     { "SCORCH_4", SCORCH_4 },
...
class ParticleSystemFXNugget : public FXNugget
{
  ...
  virtual void doFXObj(const Object *primary, const Object *secondary) const
  {
    if (primary)
    {
      ...
      {
        // HERE WE MUST BUILD A MATRIX WHICH WILL ORIENT THE NEW PARTICLE SYSTEM TO FACE AWAY FROM THE SECONDARY
        // OBJECT THE RESULT SHOULD LOOK LIKE THE DIRECTION OF THE "ATTACK" IS CARRIED THROUGH LIKE A RICOCHET
...
void FXList::doFXPos(
    ...
    const Real overrideRadius) const
{
  if (ThePartitionManager->getShroudStatusForPlayer(ThePlayerList->getLocalPlayer()->getPlayerIndex(), primary)
      != CELLSHROUD_CLEAR)
    return;
