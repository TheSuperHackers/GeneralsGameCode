    ...
    Bool slaveNeedsFullPromotion)
{
    ...
    if (slaveNeedsFullPromotion)
    {
        ...
        //																							 masterParticleSystem->m_burstCount.getMaximumValue()
        /// 2, 																							 masterParticleSystem->m_burstCount.getDistributionType());
    }
...
const FieldParse ParticleSystemTemplate::m_fieldParseTable[] = {
    ...
    //	{ "COLOR",									ParticleSystemTemplate::parseRandomRGBColor,	NULL,		offsetof(
