...
void BattleHonorTooltip(GameWindow *window, WinInstanceData *instData, UnsignedInt mouse)
{
    ...
    if (BitIsSet(battleHonor, BATTLE_HONOR_NOT_GAINED))
    {
        ...
        ); else if(BitIsSet(battleHonor, BATTLE_HONOR_SOLO_CHINA_S)) TheMouse->setCursorTooltip(
        TheGameText->fetch("TOOLTIP:BattleHonorSoloChinaSDisabled"), -1, NULL, tooltipWidth ); else if(BitIsSet(battleHonor,
        BATTLE_HONOR_SOLO_CHINA_G)) TheMouse->setCursorTooltip( TheGameText->fetch("TOOLTIP:BattleHonorSoloChinaGDisabled"),
        -1, NULL, tooltipWidth ); else if(BitIsSet(battleHonor, BATTLE_HONOR_SOLO_GLA_B)) TheMouse->setCursorTooltip(
        TheGameText->fetch("TOOLTIP:BattleHonorSoloGLABDisabled"), -1, NULL, tooltipWidth ); else if(BitIsSet(battleHonor,
        BATTLE_HONOR_SOLO_GLA_S)) TheMouse->setCursorTooltip( TheGameText->fetch("TOOLTIP:BattleHonorSoloGLASDisabled"), -1,
        NULL, tooltipWidth ); else if(BitIsSet(battleHonor, BATTLE_HONOR_SOLO_GLA_G)) TheMouse->setCursorTooltip(
        TheGameText->fetch("TOOLTIP:BattleHonorSoloGLAGDisabled"), -1, NULL, tooltipWidth );
            */
