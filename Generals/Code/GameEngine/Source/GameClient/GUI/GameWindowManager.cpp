...
Bool GameWindowManager::initTestGUI(void)
{
	...
	GadgetListBoxAddEntryText(
			...
			-1,
			0);
	GadgetListBoxAddEntryText(window, UnicodeString(L"More text"), TheWindowManager->winMakeColor(105, 105, 255, 255), -1, 0);
	...
	GadgetListBoxAddEntryText(
			...
			-1,
			-1);
	GadgetListBoxAddEntryText(window, UnicodeString(L"More text"), TheWindowManager->winMakeColor(105, 105, 255, 255), -1, -1);
	...
	window =
			TheWindowManager->gogoGadgetStaticText(NULL, WIN_STATUS_ENABLED, 200, 490, 300, 25, &instData, &textData, NULL, TRUE);
	...
	window =
			TheWindowManager->gogoGadgetTextEntry(NULL, WIN_STATUS_ENABLED, 450, 270, 400, 30, &instData, &entryData, NULL, TRUE);
