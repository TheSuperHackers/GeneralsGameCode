...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
enum ModuleType CPP_11( : Int){ MODULETYPE_BEHAVIOR = 0,
																...
																//
																// ALSO note that new drawable module types should go at the end of the existing drawable
																// modules
																//
																MODULETYPE_DRAW = 1,
...
enum ModuleInterfaceType CPP_11( : Int){
	MODULEINTERFACE_UPDATE = 0x00000001,	MODULEINTERFACE_DIE = 0x00000002,			MODULEINTERFACE_DAMAGE = 0x00000004,
	MODULEINTERFACE_CREATE = 0x00000008,	MODULEINTERFACE_COLLIDE = 0x00000010, MODULEINTERFACE_BODY = 0x00000020,
	MODULEINTERFACE_CONTAIN = 0x00000040, MODULEINTERFACE_UPGRADE = 0x00000080, MODULEINTERFACE_SPECIAL_POWER = 0x00000100,
	MODULEINTERFACE_DESTROY = 0x00000200, MODULEINTERFACE_DRAW = 0x00000400,		MODULEINTERFACE_CLIENT_UPDATE = 0x00000800
};
...
public: \
	...
	{ \
		return newInstance(cls)(thing, moduleData); \
	} \
...
private: \
	const clsmd *get##clsmd() const \
	{ \
		return (clsmd *)getModuleData(); \
	} \
\
public: \
