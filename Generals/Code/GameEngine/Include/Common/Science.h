...
class ScienceStore : public SubsystemInterface
{
  ...
  */
  ...
  /** return a list of the sciences the given player can purchase now, and a list he might be able to purchase in the
    future, but currently lacks prereqs or points for. (either might be an empty list) */
