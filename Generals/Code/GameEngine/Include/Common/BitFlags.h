...
public:
    ...
    */
    ...
    inline Bool testForAll(const BitFlags &that) const
    {
        DEBUG_ASSERTCRASH(
            that.any(),
            ("BitFlags::testForAll is always true if you ask about zero flags.  Did you mean that?"));
    ...
    static void parseSingleBitFromINI(
        INI *ini,
        void * /*instance*/,
        void *store,
        const void * /*userData*/); ///< Returns an int, the Index of the one bit
