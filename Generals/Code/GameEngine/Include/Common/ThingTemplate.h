...
//-------------------------------------------------------------------------------------------------
enum ModuleParseMode CPP_11( : Int){MODULEPARSE_NORMAL, MODULEPARSE_ADD_REMOVE_REPLACE, MODULEPARSE_INHERITABLE};
...
private:
    struct Nugget
    {
        ...
        Nugget(const AsciiString &n, const AsciiString &moduleTag, const ModuleData *d, Int i, Bool inh) :
            first(n), m_moduleTag(moduleTag), second(d), interfaceMask(i), copiedFromDefault(false), inheritable(inh)
        {
        }
    };
...
public:
    ...
    */
    ...
    Real friend_getShroudClearingRange() const
    {
