...
public:
	...
	UnicodeString getUnicodeVersion() const; ///< Return a human-readable game version number. Is decorated with localized
																					 ///< string

	AsciiString getAsciiBuildTime() const; ///< Return a formated date/time string for build time
	UnicodeString getUnicodeBuildTime() const; ///< Return a formated date/time string for build time. Is decorated with
																						 ///< localized string

	AsciiString getAsciiBuildLocation() const; ///< Return a string with the build location
	UnicodeString getUnicodeBuildLocation() const; ///< Return a string with the build location. Is decorated with localized
																								 ///< string
	...
	AsciiString getAsciiGitCommitCount() const; ///< Returns the git commit count. Is prefixed with ~ if there were uncommitted
																							///< changes.
	UnicodeString getUnicodeGitCommitCount() const; ///< Returns the git commit count. Is prefixed with ~ if there were
																									///< uncommitted changes.

	AsciiString getAsciiGitTagOrHash() const; ///< Returns the git head commit tag or hash. Is prefixed with ~ if there were
																						///< uncommitted changes.
	UnicodeString getUnicodeGitTagOrHash() const; ///< Returns the git head commit tag or hash. Is prefixed with ~ if there
	...
	UnicodeString getUnicodeProductString() const; ///< Returns a string that contains product title, version and other, if
																								 ///< specified. Is decorated with localized string
	UnicodeString getUnicodeProductVersionHashString() const; ///< Returns a string that contains the product string, game
																														///< version and hashes. Is decorated with localized string
