...
class INI
{
  ...
  void loadDirectory(AsciiString dirName, Bool subdirs, INILoadType loadType,
                     Xfer *pXfer); ///< load directory of INI files
  ...
  */
  ...
  AsciiString getNextQuotedAsciiString(); // fixed version of above.  We can't fix the regular one for fear of breaking
                                          // existing code. :-(
