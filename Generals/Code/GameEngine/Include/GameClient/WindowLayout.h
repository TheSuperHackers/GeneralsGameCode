...
// INLINING ///////////////////////////////////////////////////////////////////////////////////////
inline AsciiString WindowLayout::getFilename(void) const
{
	return m_filenameString;
}
inline GameWindow *WindowLayout::getFirstWindow(void) const
{
	return m_windowList;
}
inline Bool WindowLayout::isHidden(void) const
{
	return m_hidden;
}
...
inline void WindowLayout::setInit(WindowLayoutInitFunc init)
{
	m_init = init;
}
inline void WindowLayout::setUpdate(WindowLayoutUpdateFunc update)
{
	m_update = update;
}
inline void WindowLayout::setShutdown(WindowLayoutShutdownFunc shutdown)
{
	m_shutdown = shutdown;
}
