...
public:
	...
	virtual void registerDrawable(Drawable *draw); ///< Given a drawable, register it with the GameClient and give it a unique
																								 ///< ID
	...
	virtual void iterateDrawablesInRegion(Region3D *region, GameClientFuncPtr userFunc, void *userData); ///< Calls userFunc
																																																			 ///< for each drawable
																																																			 ///< contained within
																																																			 ///< the region
...
private:
	...
	virtual Display *createGameDisplay(void) = 0; ///< Factory for Display classes. Called during init to instantiate
																								///< TheDisplay.
	virtual InGameUI *createInGameUI(void) = 0; ///< Factory for InGameUI classes. Called during init to instantiate
																							///< TheInGameUI
	...
	virtual TerrainVisual *createTerrainVisual(void) = 0; ///< Factory for TerrainVisual classes. Called during init to
																												///< instance TheTerrainVisual
