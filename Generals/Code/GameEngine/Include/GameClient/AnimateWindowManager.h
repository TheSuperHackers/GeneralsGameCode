...
class AnimateWindowManager : public SubsystemInterface
{
  ...
  ProcessAnimateWindowSlideFromBottomTimed
      *m_slideFromBottomTimed; ///< Holds the process in which the windows slide from the Bottom in a time-based fashion
  ProcessAnimateWindowSlideFromTopFast
      *m_slideFromTopFast; ///< holds the process in wich the windows slide from the top,fast
