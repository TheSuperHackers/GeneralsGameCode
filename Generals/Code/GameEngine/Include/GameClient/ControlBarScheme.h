...
public:
	...
	void init(void);
	void update(void);
	void drawForeground(Coord2D multi, ICoord2D offset); ///< draw function to be called within a w3d draw procedure for the
																											 ///< foreground
	void drawBackground(Coord2D multi, ICoord2D offset); ///< draw function to be called within a w3d draw procedure for the
																											 ///< background
	void reset(void);
	...
	AsciiString m_side; ///< contain what faction type this command bar was made for (used when selecting command bar by
											///< template
...
public:
	...
	static void parseImagePart(INI *ini, void *instance, void *store, const void *userData); ///< Parse the image part of the
																																													 ///< INI file
	static void parseAnimatingPart(INI *ini, void *instance, void *store, const void *userData); ///< Parse the animation part
																																															 ///< of the INI file
	static void parseAnimatingPartImage(INI *ini, void *instance, void *store, const void *userData); ///< parse the image part
																																																		///< of the animation
																																																		///< part :)
