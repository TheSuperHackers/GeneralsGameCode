...
enum MappableKeyCategories CPP_11( : Int){
  CATEGORY_CONTROL = 0,   CATEGORY_INFORMATION, CATEGORY_INTERFACE, CATEGORY_SELECTION,
  CATEGORY_TAUNT,         CATEGORY_TEAM,        CATEGORY_MISC,      CATEGORY_DEBUG,
...
enum MappableKeyType CPP_11( : Int){ MK_ESC = KEY_ESC,
...
enum MappableKeyModState CPP_11( : Int){ NONE = 0,
...
enum CommandUsableInType CPP_11( : Int){ COMMANDUSABLE_NONE = 0,

                                         COMMANDUSABLE_SHELL = (1 << 0),
                                         COMMANDUSABLE_GAME = (1 << 1) };

static const char *TheCommandUsableInNames[] = { "SHELL",
                                                 "GAME",
