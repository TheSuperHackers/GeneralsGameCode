...
protected:
    enum
    {
        ...
        BUTTONFLASHTRANSITION_END, // this is the end of the sequence, we need some special defines... well put them below
                                   // here
...
public:
    ...
    {
        return m_gameWindowTransitionsFieldParseTable;
