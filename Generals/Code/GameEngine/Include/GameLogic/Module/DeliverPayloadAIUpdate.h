...
public:
    ...
    Real
        m_maxDistanceToTarget; ///< How far away from target I can unload, plus how far after target I need to turn around at
    ...
    static void buildFieldParse(MultiIniFieldParse &p)
    {
        ...
        static const FieldParse dataFieldParse[] = {
            ...
            {"PutInContainer",
             ...
             NULL,
             offsetof(DeliverPayloadAIUpdateModuleData, m_putInContainerName)},
            ...
            {"DeliveryDecal",
             ...
             NULL,
             offsetof(DeliverPayloadAIUpdateModuleData, m_deliveryDecalTemplate)},
