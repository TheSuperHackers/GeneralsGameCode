                        ...
                        public TransportPassengerInterface // lorenzen add a MobMemberInterface
{
  ...
  virtual ExitDoorType reserveDoorForExit(
      ...
      Object *specificObject); ///< All types can answer if they are free to exit or not, and you can ask about a specific
                               ///< guy or just exit anything in general
  virtual void unreserveDoorForExit(ExitDoorType exitDoor);

  virtual Bool tryToEvacuate(Bool exposeStealthedUnits); ///< Will try to kick everybody out with game checks, and will
