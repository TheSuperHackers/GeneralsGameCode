...
class SpecialPowerModuleData : public BehaviorModuleData
{
  ...
  Bool m_updateModuleStartsAttack; ///< update module determines when the special power actually starts! If true, update
                                   ///< module is required.
...
class SpecialPowerModule : public BehaviorModule, public SpecialPowerModuleInterface
{
  ...
  Bool isModuleForPower(
      const SpecialPowerTemplate *specialPowerTemplate) const; ///< is this module for the specified special power
  ...
  */
  ...
  protected:
  Bool initiateIntentToDoSpecialPower(
