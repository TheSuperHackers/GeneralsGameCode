...
public:
	...
	inline Bool isDieApplicable(const Object *obj, const DamageInfo *damageInfo) const
	{
		return m_dieMuxData.isDieApplicable(obj, damageInfo);
	}
};
...
protected:
	...
	{
		return getDieModuleData()->isDieApplicable(getObject(), damageInfo);
	}
};
