...
const Int SPAWN_UPDATE_RATE =
    LOGICFRAMES_PER_SECOND / 2; ///< This is a low priority module that only needs to be called every this many frames
...
public:
    ...
    virtual void onSpawnDeath(
        ObjectID deadSpawn,
        DamageInfo *damageInfo); ///< Something we spawned and set up to tell us it died just died.
