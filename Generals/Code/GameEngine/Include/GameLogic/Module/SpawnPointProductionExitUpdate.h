	...
	static void buildFieldParse(MultiIniFieldParse &p)
	{
		...
		static const FieldParse dataFieldParse[] = {
			{ "SpawnPointBoneName",
				...
				NULL,
				offsetof(SpawnPointProductionExitUpdateModuleData, m_spawnPointBoneNameData) },
			{ 0, 0, 0, 0 }
		};
...
protected:
	...
	ObjectID m_spawnPointOccupier[MAX_SPAWN_POINTS]; ///< Who I think is in each spot.  I can validate their existance to see
																									 ///< if I am free to exit something.
