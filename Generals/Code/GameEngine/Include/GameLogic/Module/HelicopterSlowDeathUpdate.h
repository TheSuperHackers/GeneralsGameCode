...
class HelicopterSlowDeathBehaviorModuleData : public SlowDeathBehaviorModuleData
{
  ...
  Real m_selfSpinUpdateAmount; ///< (radian) when we update the self spin every SelfSpinUpdateDelay frames, we change it
                               ///< this much, but keep it between min and max self spin
