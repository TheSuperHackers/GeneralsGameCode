...
public:
    ...
    virtual void orderAllPassengersToExit(
        CommandSourceType commandSource); ///< All of the smarts of exiting are in the passenger's AIExit.
                                          ///< removeAllFrommContain is a last ditch system call, this is the game Evacuate
