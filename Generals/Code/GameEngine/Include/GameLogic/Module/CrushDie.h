    ...
    static void buildFieldParse(MultiIniFieldParse &p)
    {
        ...
        static const FieldParse dataFieldParse[] = {
            ...
            {"BackEndCrushSound",
             ...
             NULL,
             offsetof(CrushDieModuleData, m_crushSounds[BACK_END_CRUSH])},
            {"FrontEndCrushSound",
             INI::parseAudioEventRTS,
             NULL,
             offsetof(CrushDieModuleData, m_crushSounds[FRONT_END_CRUSH])},
            ...
            {"BackEndCrushSoundPercent",
             INI::parseInt,
             NULL,
             offsetof(CrushDieModuleData, m_crushSoundPercent[BACK_END_CRUSH])},
            {"FrontEndCrushSoundPercent",
             INI::parseInt,
             NULL,
             offsetof(CrushDieModuleData, m_crushSoundPercent[FRONT_END_CRUSH])},
            {0, 0, 0, 0}};
