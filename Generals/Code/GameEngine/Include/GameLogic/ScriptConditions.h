...
public:
    ...
    virtual Bool evaluateSkirmishCommandButtonIsReady(
...
protected:
    ...
    void objectTypesFromParam(
        Parameter *pTypeParm,
        ObjectTypes *outObjectTypes); // Must pass in a valid objectTypes for outObjectTypes
    ...
    Bool evaluatePlayerUnitCondition(
    ...
    Bool evaluatePlayerHasComparisonValueExcessPower(
        Parameter *pPlayerParm,
        Parameter *pComparisonParm,
        Parameter *pKWHParm);
    Bool evaluatePlayerHasUnitTypeInArea(
        Condition *pCondition,
        Parameter *pPlayerParm,
        Parameter *pComparisonParm,
        Parameter *pCountParm,
    ...
    Bool evaluatePlayerHasUnitKindInArea(
        Condition *pCondition,
        Parameter *pPlayerParm,
        Parameter *pComparisonParm,
        Parameter *pCountParm,
    ...
    Bool evaluateSkirmishValueInArea(
        Condition *pCondition,
        Parameter *pSkirmishPlayerParm,
        Parameter *pComparisonParm,
    ...
    Bool evaluateSkirmishSuppliesWithinDistancePerimeter(
        Parameter *pSkirmishPlayerParm,
    ...
    Bool evaluateSkirmishPlayerTechBuildingWithinDistancePerimeter(
        ...
        Parameter *pDistanceParm,
        Parameter *pLocationParm);
    Bool evaluateSkirmishCommandButtonIsReady(
        Parameter *pSkirmishPlayerParm,
        Parameter *pTeamParm,
        Parameter *pCommandButtonParm,
        Bool allReady);
    Bool evaluateSkirmishUnownedFactionUnitComparison(
        Parameter *pSkirmishPlayerParm,
        Parameter *pComparisonParm,
        Parameter *pCountParm);
    Bool evaluateSkirmishPlayerHasPrereqsToBuild(Parameter *pSkirmishPlayerParm, Parameter *pObjectTypeParm);
    Bool evaluateSkirmishPlayerHasComparisonGarrisoned(
        Parameter *pSkirmishPlayerParm,
        Parameter *pComparisonParm,
        Parameter *pCountParm);
    Bool evaluateSkirmishPlayerHasComparisonCapturedUnits(
        Parameter *pSkirmishPlayerParm,
        Parameter *pComparisonParm,
        Parameter *pCountParm);
    Bool evaluateSkirmishNamedAreaExists(Parameter *pSkirmishPlayerParm, Parameter *pTriggerParm);
    Bool evaluateSkirmishPlayerHasUnitsInArea(
        Condition *pCondition,
        Parameter *pSkirmishPlayerParm,
        Parameter *pTriggerParm);
    ...
    Bool evaluateSkirmishSupplySourceSafe(
        Condition *pCondition,
        Parameter *pSkirmishPlayerParm,
