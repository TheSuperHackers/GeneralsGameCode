...
public:
	...
	void setTypeAsObstacle(Object *obstacle, Bool isFence, const ICoord2D &pos); ///< flag this cell as an obstacle, from the
																																							 ///< given one
...
public:
	...
	Bool quickDoesPathExist(const LocomotorSet &locomotorSet, const Coord3D *from, const Coord3D *to); ///< Can we build any
																																																		 ///< path at all between
																																																		 ///< the locations
																																																		 ///< (terrain &
																																																		 ///< buildings check -
