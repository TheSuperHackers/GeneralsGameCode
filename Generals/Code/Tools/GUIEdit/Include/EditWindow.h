...
// INLINING ///////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
inline HWND EditWindow::getWindowHandle(void)
{
	return m_editWindowHWnd;
}
inline void EditWindow::getSize(ICoord2D *size)
{
	*size = m_size;
}
inline void EditWindow::getPopupMenuClickPos(ICoord2D *pos)
{
	*pos = m_popupMenuClickPos;
}
...
inline ICoord2D EditWindow::getDragMoveDest(void)
{
	return m_dragMoveDest;
}
inline ICoord2D EditWindow::getDragMoveOrigin(void)
{
	return m_dragMoveOrigin;
}
