...
//=============================================================================
static LRESULT CALLBACK radioButtonPropertiesCallback(HWND hWndDialog, UINT message, WPARAM wParam, LPARAM lParam)
{
	Int returnCode;
...
HWND InitRadioButtonPropertiesDialog(GameWindow *window)
{
	...
	// fill the group combo box with all the other groups in the screen
	loadExistingGroupsCombo(GetDlgItem(dialog, COMBO_GROUP), TheWindowManager->winGetWindowList());
