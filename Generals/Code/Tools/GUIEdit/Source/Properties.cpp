...
ImageAndColorInfo imageAndColorTable[] = {
  ...
  { GWS_SCROLL_LISTBOX,
    ...
    "[Listbox] Enabled Selected Item Left End (or colors)",
    NULL,
    0,
    0 },
  ...
  { GWS_SCROLL_LISTBOX,
    ...
    "[Listbox] Enabled Selected Item Repeating Center",
    NULL,
    0,
    0 },
  { GWS_SCROLL_LISTBOX,
    LISTBOX_ENABLED_SELECTED_ITEM_SMALL_CENTER,
    "[Listbox] Enabled Selected Item Small Repeating Center",
    NULL,
    0,
    0 },
  ...
  { GWS_SCROLL_LISTBOX,
    ...
    "[Listbox] Disabled Selected Item Left End (or colors)",
    NULL,
    0,
    0 },
  ...
  { GWS_SCROLL_LISTBOX,
    ...
    "[Listbox] Disabled Selected Item Repeating Center",
    NULL,
    0,
    0 },
  { GWS_SCROLL_LISTBOX,
    LISTBOX_DISABLED_SELECTED_ITEM_SMALL_CENTER,
    "[Listbox] Disabled Selected Item Small Repeating Center",
    NULL,
    0,
    0 },
  ...
  { GWS_SCROLL_LISTBOX,
    ...
    "[Listbox] Hilite Selected Item Left End (or colors)",
    NULL,
    0,
    0 },
  ...
  { GWS_SCROLL_LISTBOX,
    ...
    "[Listbox] Hilite Selected Item Small Repeating Center",
    NULL,
    0,
    0 },
  ...
  { GWS_SCROLL_LISTBOX,
    ...
    "[Slider [Listbox]] Enabled Top End (or bar colors for no image)",
    NULL,
    0,
    0 },
  ...
  { GWS_SCROLL_LISTBOX,
    ...
    "[Slider [Listbox]] Enabled Repeating Small Cener",
    NULL,
    0,
    0 },
  { GWS_SCROLL_LISTBOX,
    LISTBOX_SLIDER_DISABLED_TOP,
    "[Slider [Listbox]] Disabled Top End (or bar colors for no image)",
    NULL,
    0,
    0 },
  ...
  { GWS_SCROLL_LISTBOX,
    ...
    "[Slider [Listbox]] Disabled Repeating Small Cener",
    NULL,
    0,
    0 },
  { GWS_SCROLL_LISTBOX,
    LISTBOX_SLIDER_HILITE_TOP,
    "[Slider [Listbox]] Hilite Top End (or bar colors for no image)",
    NULL,
    0,
    0 },
  ...
  { GWS_COMBO_BOX,
    ...
    "[ComboBox] Enabled Selected Item Left End (or colors)",
    NULL,
    0,
    0 },
  ...
  { GWS_COMBO_BOX,
    ...
    "[ComboBox] Enabled Selected Item Small Repeating Center",
    NULL,
    0,
    0 },
  ...
  { GWS_COMBO_BOX,
    ...
    "[ComboBox] Disabled Selected Item Left End (or colors)",
    NULL,
    0,
    0 },
  ...
  { GWS_COMBO_BOX,
    ...
    "[ComboBox] Disabled Selected Item Repeating Center",
    NULL,
    0,
    0 },
  { GWS_COMBO_BOX,
    COMBOBOX_DISABLED_SELECTED_ITEM_SMALL_CENTER,
    "[ComboBox] Disabled Selected Item Small Repeating Center",
    NULL,
    0,
    0 },
  ...
  { GWS_COMBO_BOX,
    ...
    "[ComboBox] Hilite Selected Item Small Repeating Center",
    NULL,
    0,
    0 },
  ...
  { GWS_COMBO_BOX,
    ...
    "[Text Entry [ComboBox]] Enabled Left End (Or colors for no image)",
    NULL,
    0,
    0 },
  ...
  { GWS_COMBO_BOX,
    ...
    "[Text Entry [ComboBox]] Enabled Small Repeating Center",
    NULL,
    0,
    0 },
  { GWS_COMBO_BOX,
    COMBOBOX_EDIT_BOX_DISABLED_LEFT,
    "[Text Entry [ComboBox]] Disabled Left End (Or colors for no image)",
    NULL,
    0,
    0 },
  ...
  { GWS_COMBO_BOX,
    ...
    "[Text Entry [ComboBox]] Disabled Small Repeating Center",
    NULL,
    0,
    0 },
  { GWS_COMBO_BOX,
    COMBOBOX_EDIT_BOX_HILITE_LEFT,
    "[Text Entry [ComboBox]] Hilite Left End (Or colors for no image)",
    NULL,
    0,
    0 },
  ...
  { GWS_COMBO_BOX,
    ...
    "[Text Entry [ComboBox]] Hilite Small Repeating Center",
    NULL,
    0,
    0 },
  ...
  { GWS_COMBO_BOX,
    ...
    "[Listbox [ComboBox]] Enabled Selected Item Left End (or colors)",
    NULL,
    0,
    0 },
  { GWS_COMBO_BOX,
    COMBOBOX_LISTBOX_ENABLED_SELECTED_ITEM_RIGHT,
    "[Listbox [ComboBox]] Enabled Selected Item Right End",
    NULL,
    0,
    0 },
  { GWS_COMBO_BOX,
    COMBOBOX_LISTBOX_ENABLED_SELECTED_ITEM_CENTER,
    "[Listbox [ComboBox]] Enabled Selected Item Repeating Center",
    NULL,
    0,
    0 },
  { GWS_COMBO_BOX,
    COMBOBOX_LISTBOX_ENABLED_SELECTED_ITEM_SMALL_CENTER,
    "[Listbox [ComboBox]] Enabled Selected Item Small Repeating Center",
    NULL,
    0,
    0 },
  ...
  { GWS_COMBO_BOX,
    ...
    "[Listbox [ComboBox]] Disabled Selected Item Left End (or colors)",
    NULL,
    0,
    0 },
  { GWS_COMBO_BOX,
    COMBOBOX_LISTBOX_DISABLED_SELECTED_ITEM_RIGHT,
    "[Listbox [ComboBox]] Disabled Selected Item Right End",
    NULL,
    0,
    0 },
  { GWS_COMBO_BOX,
    COMBOBOX_LISTBOX_DISABLED_SELECTED_ITEM_CENTER,
    "[Listbox [ComboBox]] Disabled Selected Item Repeating Center",
    NULL,
    0,
    0 },
  { GWS_COMBO_BOX,
    COMBOBOX_LISTBOX_DISABLED_SELECTED_ITEM_SMALL_CENTER,
    "[Listbox [ComboBox]] Disabled Selected Item Small Repeating Center",
    NULL,
    0,
    0 },
  ...
  { GWS_COMBO_BOX,
    ...
    "[Listbox [ComboBox]] Hilite Selected Item Left End (or colors)",
    NULL,
    0,
    0 },
  { GWS_COMBO_BOX,
    COMBOBOX_LISTBOX_HILITE_SELECTED_ITEM_RIGHT,
    "[Listbox [ComboBox]] Hilite Selected Item Right End",
    NULL,
    0,
    0 },
  { GWS_COMBO_BOX,
    COMBOBOX_LISTBOX_HILITE_SELECTED_ITEM_CENTER,
    "[Listbox [ComboBox]] Hilite Selected Item Repeating Center",
    NULL,
    0,
    0 },
  { GWS_COMBO_BOX,
    COMBOBOX_LISTBOX_HILITE_SELECTED_ITEM_SMALL_CENTER,
    "[Listbox [ComboBox]] Hilite Selected Item Small Repeating Center",
    NULL,
    0,
    0 },
  ...
  { GWS_COMBO_BOX,
    ...
    "[Up Button [Listbox [ComboBox]]] Enabled (Pushed)",
    NULL,
    0,
    0 },
  ...
  { GWS_COMBO_BOX,
    ...
    "[Up Button [Listbox [ComboBox]]] Disabled (Pushed)",
    NULL,
    0,
    0 },
  ...
  { GWS_COMBO_BOX,
    ...
    "[Up Button [Listbox [ComboBox]]] Hilite (Pushed)",
    NULL,
    0,
    0 },
  ...
  { GWS_COMBO_BOX,
    ...
    "[Down Button [Listbox [ComboBox]]] Enabled (Pushed)",
    NULL,
    0,
    0 },
  { GWS_COMBO_BOX,
    COMBOBOX_LISTBOX_DOWN_BUTTON_DISABLED,
    "[Down Button [Listbox [ComboBox]]] Disabled (Normal)",
    NULL,
    0,
    0 },
  { GWS_COMBO_BOX,
    COMBOBOX_LISTBOX_DOWN_BUTTON_DISABLED_PUSHED,
    "[Down Button [Listbox [ComboBox]]] Disabled (Pushed)",
    NULL,
    0,
    0 },
  ...
  { GWS_COMBO_BOX,
    ...
    "[Down Button [Listbox [ComboBox]]] Hilite (Pushed)",
    NULL,
    0,
    0 },
  ...
  { GWS_COMBO_BOX,
    ...
    "[Slider [Listbox [ComboBox]]] Enabled Top End (or bar colors for no image)",
    NULL,
    0,
    0 },
  ...
  { GWS_COMBO_BOX,
    ...
    "[Slider [Listbox [ComboBox]]] Enabled Repeating Center",
    NULL,
    0,
    0 },
  { GWS_COMBO_BOX,
    COMBOBOX_LISTBOX_SLIDER_ENABLED_SMALL_CENTER,
    "[Slider [Listbox [ComboBox]]] Enabled Repeating Small Cener",
    NULL,
    0,
    0 },
  { GWS_COMBO_BOX,
    COMBOBOX_LISTBOX_SLIDER_DISABLED_TOP,
    "[Slider [Listbox [ComboBox]]] Disabled Top End (or bar colors for no image)",
    NULL,
    0,
    0 },
  { GWS_COMBO_BOX,
    COMBOBOX_LISTBOX_SLIDER_DISABLED_BOTTOM,
    "[Slider [Listbox [ComboBox]]] Disabled Bottom End",
    NULL,
    0,
    0 },
  { GWS_COMBO_BOX,
    COMBOBOX_LISTBOX_SLIDER_DISABLED_CENTER,
    "[Slider [Listbox [ComboBox]]] Disabled Repeating Center",
    NULL,
    0,
    0 },
  { GWS_COMBO_BOX,
    COMBOBOX_LISTBOX_SLIDER_DISABLED_SMALL_CENTER,
    "[Slider [Listbox [ComboBox]]] Disabled Repeating Small Cener",
    NULL,
    0,
    0 },
  { GWS_COMBO_BOX,
    COMBOBOX_LISTBOX_SLIDER_HILITE_TOP,
    "[Slider [Listbox [ComboBox]]] Hilite Top End (or bar colors for no image)",
    NULL,
    0,
    0 },
  ...
  { GWS_COMBO_BOX,
    ...
    "[Slider [Listbox [ComboBox]]] Hilite Repeating Center",
    NULL,
    0,
    0 },
  { GWS_COMBO_BOX,
    COMBOBOX_LISTBOX_SLIDER_HILITE_SMALL_CENTER,
    "[Slider [Listbox [ComboBox]]] Hilite Repeating Small Cener",
    NULL,
    0,
    0 },
  ...
  { GWS_COMBO_BOX,
    ...
    "[Slider Thumb [Listbox [ComboBox]]] Enabled (Normal)",
    NULL,
    0,
    0 },
  { GWS_COMBO_BOX,
    COMBOBOX_LISTBOX_SLIDER_THUMB_ENABLED_PUSHED,
    "[Slider Thumb [Listbox [ComboBox]]] Enabled (Pushed)",
    NULL,
    0,
    0 },
  { GWS_COMBO_BOX,
    COMBOBOX_LISTBOX_SLIDER_THUMB_DISABLED,
    "[Slider Thumb [Listbox [ComboBox]]] Disabled (Normal)",
    NULL,
    0,
    0 },
  { GWS_COMBO_BOX,
    COMBOBOX_LISTBOX_SLIDER_THUMB_DISABLED_PUSHED,
    "[Slider Thumb [Listbox [ComboBox]]] Disabled (Pushed)",
    NULL,
    0,
    0 },
  ...
  { GWS_COMBO_BOX,
    ...
    "[Slider Thumb [Listbox [ComboBox]]] Hilite (Pushed)",
    NULL,
    0,
    0 },
  ...
  { GWS_PROGRESS_BAR,
    ...
    "[Bar] Enabled Fill Bar Left End (or color for no images)",
    NULL,
    0,
    0 },
  ...
  { GWS_PROGRESS_BAR,
    ...
    "[Bar] Disabled Fill Bar Left End (or color for no images)",
    NULL,
    0,
    0 },
...
static void saveTextLabel(HWND edit, GameWindow *window)
{
  ...
  //
  UnicodeString text;
  text = TheGameText->fetch(
      (char *)instData->m_textLabelString.str()); // TheWindowManager->winTextLabelToText( instData->m_textLabelString );
...
void CommonDialogInitialize(GameWindow *window, HWND dialog)
{
  ...
  //
  SendMessage(GetDlgItem(dialog, EDIT_NAME), EM_SETLIMITTEXT, MAX_WINDOW_NAME_LEN - 16, 0);

  // set the text explaining the name size limit to the user
  char buffer[128];
  sprintf(buffer, "Name length + layout filename length (.wnd) must not exceed %d characters.", MAX_WINDOW_NAME_LEN);
  ...
  LoadTextStateCombo(
      GetDlgItem(dialog, COMBO_TEXT_STATE),
...
Bool SaveCommonDialogProperties(HWND dialog, GameWindow *window)
{
  ...
  if (TheEditor->windowIsGadget(window))
    adjustGadgetDrawMethods(BitIsSet(window->winGetStatus(), WIN_STATUS_IMAGE), window);

  // save colors
  window->winSetEnabledTextColors(textDrawData[enabledTextIndex].color, textDrawData[enabledTextIndex].borderColor);
  window->winSetDisabledTextColors(textDrawData[disabledTextIndex].color, textDrawData[disabledTextIndex].borderColor);
  window->winSetHiliteTextColors(textDrawData[hiliteTextIndex].color, textDrawData[hiliteTextIndex].borderColor);
...
void LoadImageListComboBox(HWND comboBox)
{
  ...
  for (image = TheMappedImageCollection->firstImage(); image; image = TheMappedImageCollection->nextImage(image))
  {
...
void LoadHeaderTemplateListComboBox(HWND comboBox, AsciiString selected)
{
  ...
  for (ht = TheHeaderTemplateManager->getFirstHeader(); ht; ht = TheHeaderTemplateManager->getNextHeader(ht))
  {
...
void PositionWindowOnScreen(HWND window, Int x, Int y)
{
  ...
  // place the window
  MoveWindow(window, windowPos.x, windowPos.y, windowSize.x, windowSize.y, TRUE);
...
//=============================================================================
Bool HandleCommonDialogMessages(HWND hWndDialog, UINT message, WPARAM wParam, LPARAM lParam, Int *returnCode)
{
  Bool used = FALSE;
      ...
      switch (controlID)
      {
        ...
        case COMBO_IMAGE:
        {
          ...
          if (notifyCode == CBN_SELCHANGE)
          {
            ...
            StoreImageAndColor(info->stateID, newImage, info->color, info->borderColor);
        ...
        case BUTTON_TEXT_BORDER_COLOR:
        {
          ...
          {
            Color newColor =
                GameMakeColor(selectedColor->red, selectedColor->green, selectedColor->blue, selectedColor->alpha);
