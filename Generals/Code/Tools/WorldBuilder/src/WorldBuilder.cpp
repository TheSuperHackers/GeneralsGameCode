...
CWorldBuilderApp::CWorldBuilderApp() :
		m_curTool(NULL), m_selTool(NULL), m_lockCurTool(0), m_3dtemplate(NULL), m_pasteMapObjList(NULL)
{
...
BOOL CWorldBuilderApp::OnCmdMsg(UINT nID, int nCode, void *pExtra, AFX_CMDHANDLERINFO *pHandlerInfo)
{
