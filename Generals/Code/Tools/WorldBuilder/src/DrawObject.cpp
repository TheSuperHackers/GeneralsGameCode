...
Int DrawObject::initData(void)
{
	...
	m_vertexBufferTile1 =
			NEW_REF(DX8VertexBufferClass, (DX8_FVF_XYZDUV1, m_numTriangles * 3, DX8VertexBufferClass::USAGE_DEFAULT));
	m_vertexBufferTile2 =
			NEW_REF(DX8VertexBufferClass, (DX8_FVF_XYZDUV1, m_numTriangles * 3, DX8VertexBufferClass::USAGE_DEFAULT));

	m_vertexFeedback =
			NEW_REF(DX8VertexBufferClass, (DX8_FVF_XYZDUV1, NUM_FEEDBACK_VERTEX, DX8VertexBufferClass::USAGE_DEFAULT));
