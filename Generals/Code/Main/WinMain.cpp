...
#define PBT_APMRESUMESUSPEND 0x0007
            ...
            case WM_SYSCOMMAND:
                ...
                {
                    case SC_KEYMENU:
                        // TheSuperHackers @bugfix Mauller 10/05/2025 Always handle this command to prevent halting the game
...
{
    DWORD windowStyle;
    Int startWidth = DEFAULT_DISPLAY_WIDTH, startHeight = DEFAULT_DISPLAY_HEIGHT;
...
Int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, Int nCmdShow)
{
    ...
    try
    {
        ...
        gLoadScreenBitmap =
            (HBITMAP)LoadImage(hInstance, "Install_Final.bmp", IMAGE_BITMAP, 0, 0, LR_SHARED | LR_LOADFROMFILE);
