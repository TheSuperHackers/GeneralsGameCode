...
class W3DAssetManager : public WW3DAssetManager
{
  ...
  /*	virtual RenderObjClass * Create_Render_Obj(const char * name, float scale, const Vector3 &hsv_shift);
    ...
    Recolor_Vertices(unsigned int *color, int count, const Vector3 &hsv_shift); void Recolor_Mesh(RenderObjClass *robj,
    const Vector3 &hsv_shift); TextureClass * Recolor_Texture(TextureClass *texture, const Vector3 &hsv_shift);
