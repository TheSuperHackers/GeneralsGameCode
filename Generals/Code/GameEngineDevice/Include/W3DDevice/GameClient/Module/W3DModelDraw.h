...
public:
	...
	virtual void updateProjectileClipStatus(
			...
			WeaponSlotType slot); ///< This
														...
														///< is
														///< set.
	virtual void updateDrawModuleSupplyStatus(Int maxSupply, Int currentSupply); ///< This will do visual feedback on Supplies
																																							 ///< carried
...
private:
	...
	void doHideShowProjectileObjects(UnsignedInt showCount, UnsignedInt maxCount, WeaponSlotType slot); ///< Means effectively,
																																																			///< show m of n.
