...
public:
	...
	void draw(Int x, Int y, Color color, Color dropColor, Int xDrop, Int yDrop); ///< render text with the drop shadow being at
																																							 ///< the offsets passed in
...
// INLINING ///////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
inline void W3DDisplayString::usingResources(UnsignedInt frame)
{
	m_lastResourceFrame = frame;
}
