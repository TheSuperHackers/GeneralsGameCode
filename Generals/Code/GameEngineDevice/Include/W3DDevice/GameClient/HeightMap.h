...
public:
    ...
    virtual bool Cast_Ray(
        RayCollisionTestClass &raytest); // This CANNOT be Bool, as it will not inherit properly if you make Bool == Int
    ...
    void worldBuilderUpdateBridgeTowers(
        W3DAssetManager *assetManager,
        SimpleSceneClass *scene); ///< for the editor updating of bridge tower visuals
    ...
    Bool getMaximumVisibleBox(
        const FrustumClass &frustum,
        AABoxClass *box,
        Bool ignoreMaxHeight); ///< 3d extent of visible terrain.
