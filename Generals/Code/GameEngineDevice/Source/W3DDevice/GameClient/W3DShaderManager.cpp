...
W3DShaderInterface **MasterShaderList[] =
    {TerrainShaderList, ShroudShaderList, RoadShaderList, MaskShaderList, CloudShaderList, NULL};
...
*/
W3DFilterInterface **MasterFilterList[] = {ScreenBWFilterList, ScreenMotionBlurFilterList, ScreenCrossFadeFilterList, NULL};
