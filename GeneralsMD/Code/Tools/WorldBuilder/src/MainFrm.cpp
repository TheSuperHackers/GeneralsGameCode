...
#undef WRAP
	...
	if (!m_wndToolBar.CreateEx(
					this,
					TBSTYLE_FLAT,
					WS_CHILD | WS_VISIBLE | CBRS_TOP | CBRS_GRIPPER | CBRS_TOOLTIPS | CBRS_FLYBY | CBRS_SIZE_FIXED)
...
void CMainFrame::adjustWindowSize(void)
{
	...
	this->SetWindowPos(NULL, 0, 0, newWidth, newHeight,
