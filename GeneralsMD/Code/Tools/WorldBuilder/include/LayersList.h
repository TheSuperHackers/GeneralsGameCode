...
public:
    ...
    void resetLayers();
    void addMapObjectToLayersList(
        IN MapObject *objToAdd,
        AsciiString layerToAddTo = AsciiString(TheDefaultLayerName.c_str()));
    void addPolygonTriggerToLayersList(
        IN PolygonTrigger *triggerToAdd,
        AsciiString layerToAddTo = AsciiString(TheDefaultLayerName.c_str()));
...
protected:
    ...
    Bool findMapObjectAndList(
        IN MapObject *MapObjectToFind,
        OUT ListLayerIt *layerIt = NULL,
        OUT ListMapObjectPtrIt *MapObjectIt = NULL);
    Bool findPolygonTriggerAndList(
        IN PolygonTrigger *PolygonTriggerToFind,
        OUT ListLayerIt *layerIt = NULL,
    ...
    void removeMapObjectFromLayer(
        IN MapObject *objToRemove,
        IN ListLayerIt *layerIt = NULL,
        IN ListMapObjectPtrIt *MapObjectIt = NULL);
    void removePolygonTriggerFromLayer(
