...
public:
	...
	static inline TextureClass *getShaderTexture(Int stage)
	{
	...
	static HRESULT LoadAndCreateD3DShader(
	...
	static Bool testMinimumRequirements(
	...
	// Filter methods
	static Bool filterPreRender(FilterTypes filter, Bool &skipRender, CustomScenePassModes &scenePassMode); ///< Set up at
																																																					///< start of
																																																					///< render.  Only
																																																					///< applies to
																																																					///< screen filter
																																																					///< shaders.
	static Bool filterPostRender(
			FilterTypes filter,
			FilterModes mode,
			Coord2D &scrollDelta,
