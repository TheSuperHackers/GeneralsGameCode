...
protected:
    ...
    LightClass
        *m_globalLight[LightEnvironmentClass::MAX_LIGHTS]; ///< The global directional light (sun, moon) Applies to objects.
    ...
    LightClass *m_infantryLight[LightEnvironmentClass::MAX_LIGHTS]; ///< The global direction light modified to make infantry
                                                                    ///< easier to see.
    Int m_numGlobalLights; ///< number of global lights
    LightEnvironmentClass
        m_defaultLightEnv; ///< default light environment applied to objects without custom/dynamic lighting.
    LightEnvironmentClass m_foggedLightEnv; ///< default light environment applied to objects without custom/dynamic
                                            ///< lighting.
    ...
    MaterialPassClass
        *m_heatVisionOnlyPass; ///< Custom render pass applied in place of regular pass on objects with heat vision effect.
    MaterialPassClass
        *m_frenzyMaterialPass; ///< Custom render pass applied in place of regular pass on objects with FRENZY effect.
    ...
    RenderObjClass *
        *m_nonOccludersOrOccludees; ///< objects which are neither bockers or blockees (small rocks, shrubs, etc.).
