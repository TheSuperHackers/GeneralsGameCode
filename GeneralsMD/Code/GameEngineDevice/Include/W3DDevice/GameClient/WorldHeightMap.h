...
#define NO_EVAL_TILING_MODES
  ...
  UnsignedByte *m_seismicUpdateFlag; ///< array of bits to prevent ovelapping physics-update regions from doubling effects
                                     ///< on shared cells
  ...
  TerrainTextureClass *getFlatTexture(
      Int xCell,
      Int yCell,
      Int cellWidth,
      Int pixelsPerCell); //< generates and returns the terrain texture
