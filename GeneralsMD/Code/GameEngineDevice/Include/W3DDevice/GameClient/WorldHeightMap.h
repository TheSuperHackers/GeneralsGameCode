...
protected:
	...
	UnsignedByte *m_seismicUpdateFlag; ///< array of bits to prevent ovelapping physics-update regions from doubling effects on
																		 ///< shared cells
...
public: // tile and texture info.
	...
	/// UV mapping data for a cell to map into the terrain texture.  Returns true if the textures had to be stretched for
	/// cliffs.
...
public: // Flat tile texture info.
	TerrainTextureClass *getFlatTexture(Int xCell, Int yCell, Int cellWidth, Int pixelsPerCell); //< generates and returns the
																																															 // terrain texture
