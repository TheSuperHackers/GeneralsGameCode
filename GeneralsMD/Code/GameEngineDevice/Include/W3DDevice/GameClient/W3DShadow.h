...
public:
	...
	void Reset(void);
	Shadow *addShadow(RenderObjClass *robj, Shadow::ShadowTypeInfo *shadowInfo = NULL, Drawable *draw = NULL); ///< adds shadow
																																																						 ///< caster to
																																																						 ///< rendering
																																																						 ///< system.
	...
	inline void setStencilShadowMask(int mask)
	{
		m_stencilShadowMask = mask;
