...
public:
	...
	W3DProjectedShadow *addShadow(RenderObjClass *robj, Shadow::ShadowTypeInfo *shadowInfo, Drawable *draw); ///< add a new
																																																					 ///< shadow with
																																																					 ///< texture of
																																																					 ///< given name or
																																																					 ///< that of robj.
	W3DProjectedShadow *createDecalShadow(Shadow::ShadowTypeInfo *shadowInfo); ///< add a new shadow with texture of given name
																																						 ///< or that of robj.
...
public:
	...
	void updateProjectionParameters(const Matrix3D &cameraXform); ///< recompute projection matrix - needed when light or
																																///< object moves.
