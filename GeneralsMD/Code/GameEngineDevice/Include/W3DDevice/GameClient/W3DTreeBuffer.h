...
enum W3DToppleState CPP_11( : Int){TOPPLE_UPRIGHT = 0, TOPPLE_FALLING, TOPPLE_FOGGED, TOPPPLE_SHROUDED, TOPPLE_DOWN};
...
protected:
    ...
    void loadTreesInVertexAndIndexBuffers(
