...
private:
	...
	/*	virtual RenderObjClass * Create_Render_Obj(const char * name, float scale, const Vector3 &hsv_shift);
		...
		Recolor_Mesh(RenderObjClass *robj, const Vector3 &hsv_shift); TextureClass * Recolor_Texture(TextureClass *texture, const
		Vector3 &hsv_shift); TextureClass * Recolor_Texture_One_Time(TextureClass *texture, const Vector3 &hsv_shift);
