...
void W3DCustomEdging::loadEdgingsInVertexAndIndexBuffers(WorldHeightMap *pMap, Int minX, Int maxX, Int minY, Int maxY)
{
    ...
    for (row = minY; row < maxY - 1; row++)
    {
        for (column = minX; column < maxX - 1; column++)
        {
            ...
            Bool flipForBlend;
            pMap->getAlphaUVData(
                column - pMap->getDrawOrgX(),
                row - pMap->getDrawOrgY(),
                UA,
                VA,
                alpha,
                &flipForBlend,
...
{
    m_vertexEdging =
        NEW_REF(DX8VertexBufferClass, (DX8_FVF_XYZDUV2, MAX_EDGE_VERTEX + 4, DX8VertexBufferClass::USAGE_DYNAMIC));
...
//=============================================================================
void W3DCustomEdging::drawEdging(
    WorldHeightMap *pMap,
    Int minX,
    Int maxX,
    Int minY,
