...
#define SNOW_BATCH_SIZE \
	2048 // we render at most this many particles per drawprimitive call.  This number * 6 must be less than 65536 to fit into
			 // index buffer.
...
Bool W3DSnowManager::ReAcquireResources(void)
{
	...
	{
		m_indexBuffer = NEW_REF(DX8IndexBufferClass, (SNOW_BATCH_SIZE * 6)); // allocate 2 triangles per flake, each with 3
																																				 // indices.
