...
void W3DTankTruckDraw::updateBones(void)
{
    if (getW3DTankTruckDrawModuleData())
    {
        ...
        {
            m_frontLeftTireBone =
                getRenderObject()->Get_Bone_Index(getW3DTankTruckDrawModuleData()->m_frontLeftTireBoneName.str());
            DEBUG_ASSERTCRASH(
                m_frontLeftTireBone,
            ...
            m_frontRightTireBone =
                getRenderObject()->Get_Bone_Index(getW3DTankTruckDrawModuleData()->m_frontRightTireBoneName.str());
            DEBUG_ASSERTCRASH(
                m_frontRightTireBone,
        ...
        {
            m_rearLeftTireBone =
                getRenderObject()->Get_Bone_Index(getW3DTankTruckDrawModuleData()->m_rearLeftTireBoneName.str());
            DEBUG_ASSERTCRASH(
                m_rearLeftTireBone,
            ...
            m_rearRightTireBone =
                getRenderObject()->Get_Bone_Index(getW3DTankTruckDrawModuleData()->m_rearRightTireBoneName.str());
            DEBUG_ASSERTCRASH(
                m_rearRightTireBone,
                ("Missing rear-left tire bone %s in model %s",
        ...
        if (!getW3DTankTruckDrawModuleData()->m_midFrontLeftTireBoneName.isEmpty())
        {
            m_midFrontLeftTireBone =
                getRenderObject()->Get_Bone_Index(getW3DTankTruckDrawModuleData()->m_midFrontLeftTireBoneName.str());
            DEBUG_ASSERTCRASH(
                m_midFrontLeftTireBone,
            ...
            m_midFrontRightTireBone =
                getRenderObject()->Get_Bone_Index(getW3DTankTruckDrawModuleData()->m_midFrontRightTireBoneName.str());
            DEBUG_ASSERTCRASH(
                m_midFrontRightTireBone,
        ...
        if (!getW3DTankTruckDrawModuleData()->m_midRearLeftTireBoneName.isEmpty())
        {
            m_midRearLeftTireBone =
                getRenderObject()->Get_Bone_Index(getW3DTankTruckDrawModuleData()->m_midRearLeftTireBoneName.str());
            DEBUG_ASSERTCRASH(
                m_midRearLeftTireBone,
            ...
            m_midRearRightTireBone =
                getRenderObject()->Get_Bone_Index(getW3DTankTruckDrawModuleData()->m_midRearRightTireBoneName.str());
            DEBUG_ASSERTCRASH(
                m_midRearRightTireBone,
                    ...
                    for (Int j = 0; j < mat->Vertex_Material_Count(); j++)
                    {
                        ...
                        if (mapper && mapper->Mapper_ID() == TextureMapperClass::MAPPER_ID_LINEAR_OFFSET)
                        {
                            ...
                            subObj->Set_User_Data(
                                &m_treads[m_treadCount].m_materialSettings); // tell W3D about custom material settings
...
void W3DTankTruckDraw::doDrawModule(const Matrix3D *transformMtx)
{
    ...
    if (m_treadCount)
    {
        ...
        /* Commented out because these vehicles are presumed not to turn via treads.
                ...
                if ((turn=physics->getTurning()) != TURN_NONE && physics->getSpeed()/maxSpeed <
        ...
        if (physics->isMotive()
            && physics->getVelocityMagnitude() / maxSpeed >= getW3DTankTruckDrawModuleData()->m_treadDriveSpeedFraction)
