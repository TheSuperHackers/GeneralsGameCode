...
#ifdef TRACY_ENABLE
void W3DDisplay::InitTracyCaptureImage()
{
	ResetTracyCaptureImage();
...
{
	if (!m_tracySurfaceClass || !m_tracyIntermediateTexture || !m_tracyRenderTarget)
	{
		InitTracyCaptureImage();
	}
