...
LightEnvironmentClass::LightEnvironmentClass(void) :
		LightCount(0), ObjectCenter(0, 0, 0), OutputAmbient(0, 0, 0), FillLight(), FillIntensity(0.0f)
{
}
...
void LightEnvironmentClass::Add_Light(const LightClass &light)
{
	...
	*/
	...
	{
		// Insert the light into the sorted list of InputLights if it's contribution is greater than the any of the current
		// number of lights
		...
		// If the light was not inserted but there are still spots empty in the InputLights list, insert the lights at the end of
		// the list
