...
void ShaderClass::Apply()
{
           ...
           | ShaderClass::MASK_ALPHATEST))
    {
        ...
        if (Get_Alpha_Test() == ShaderClass::ALPHATEST_ENABLE)
        {
            unsigned char alphareference =
                0x60; // Alpha reference value that produces best results with mip-mapped textures.
    ...
    int sec_mask =
        ShaderClass::MASK_POSTDETAILALPHAFUNC | ShaderClass::MASK_POSTDETAILCOLORFUNC | ShaderClass::MASK_TEXTURING;
