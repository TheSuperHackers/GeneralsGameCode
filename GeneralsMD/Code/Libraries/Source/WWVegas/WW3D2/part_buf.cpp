...
void ParticleBufferClass::Render_Line(RenderInfoClass &rinfo)
{
    ...
    if (tmp_points.Count() > 0)
    {
        ...
        while (end < count)
        {
            ...
            {
                LineRenderer
                    ->Render(rinfo, Transform, end - start, &(tmp_points[start]), bounding_sphere, &(tmp_diffuse[start]));
            }
            start = end;
        }
    }
...
void ParticleBufferClass::Render_Line_Group(RenderInfoClass &rinfo)
{
    ...
    switch (tailtype)
    {
        ...
        case SAME_AS_HEAD:
            ...
            {
                REF_PTR_RELEASE(TailDiffuse);
                DefaultTailDiffuse.Set(
                    ColorKeyFrameValues[0].X,
                    ColorKeyFrameValues[0].Y,
                    ColorKeyFrameValues[0].Z,
