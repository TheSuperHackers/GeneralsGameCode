...
ConstFXListPtr DamageFX::getDamageFXList(DamageType t, Real damageAmount, const Object *source) const
{
	...
	*/
	...
	ConstFXListPtr fx = damageAmount >= dfx.m_amountForMajorFX ? dfx.m_majorDamageFXList : dfx.m_minorDamageFXList;
...
{
	static const FieldParse myFieldParse[] = { { "AmountForMajorFX", parseAmount, NULL, 0 },
