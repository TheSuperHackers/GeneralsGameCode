...
const FieldParse ThingTemplate::s_objectFieldParseTable[] =
    {{"DisplayName", INI::parseAndTranslateLabel, nullptr,
     ...
     {"TransportSlotCount", INI::parseUnsignedByte, nullptr,
      offsetof(ThingTemplate, m_transportSlotCount)},
     {"FenceWidth", INI::parseReal, nullptr,
      offsetof(ThingTemplate, m_fenceWidth)},
     {"FenceXOffset", INI::parseReal, nullptr,
     ...
     {"VisionRange", INI::parseReal, nullptr,
      offsetof(ThingTemplate, m_visionRange)},
     {"ShroudClearingRange", INI::parseReal, nullptr,
      offsetof(ThingTemplate, m_shroudClearingRange)},
     {"ShroudRevealToAllRange", INI::parseReal, nullptr,
      offsetof(ThingTemplate, m_shroudRevealToAllRange)},

     {"PlacementViewAngle", INI::parseAngleReal, nullptr,
      offsetof(ThingTemplate, m_placementViewAngle)},

     {"FactoryExitWidth", INI::parseReal, nullptr,
      offsetof(ThingTemplate, m_factoryExitWidth)},
     {"FactoryExtraBibWidth", INI::parseReal, nullptr,
     ...
     {"IsTrainable", INI::parseBool, nullptr,
      offsetof(ThingTemplate, m_isTrainable)},
     {"EnterGuard", INI::parseBool, nullptr,
      offsetof(ThingTemplate, m_enterGuard)},
     {"HijackGuard", INI::parseBool, nullptr,
      offsetof(ThingTemplate, m_hijackGuard)},

     {"Side", INI::parseAsciiString, nullptr,
     ...
     {"BuildCost", INI::parseUnsignedShort, nullptr,
      offsetof(ThingTemplate, m_buildCost)},
     {"BuildTime", INI::parseReal, nullptr,
      offsetof(ThingTemplate, m_buildTime)},
     {"RefundValue", INI::parseUnsignedShort, nullptr,
     ...
     {"EnergyProduction", INI::parseInt, nullptr,
      offsetof(ThingTemplate, m_energyProduction)},
     {"EnergyBonus", INI::parseInt, nullptr,
      offsetof(ThingTemplate, m_energyBonus)},
     {"IsForbidden", INI::parseBool, nullptr,
      offsetof(ThingTemplate, m_isForbidden)},
     {"IsPrerequisite", INI::parseBool, nullptr,
     ...
     {"KindOf", KindOfMaskType::parseFromINI, nullptr,
      offsetof(ThingTemplate, m_kindof)},
     {"CommandSet", INI::parseAsciiString, nullptr,
      offsetof(ThingTemplate, m_commandSetString)},
     {"BuildVariations", INI::parseAsciiStringVector, nullptr,
     ...
     {"SelectPortrait", INI::parseAsciiString, nullptr,
      offsetof(ThingTemplate, m_selectedPortraitImageName)},
     {"ButtonImage", INI::parseAsciiString, nullptr,
      offsetof(ThingTemplate, m_buttonImageName)},

     // Code renderer handles these states now.
     //{ "InventoryImageEnabled",	INI::parseAsciiString,	nullptr,
     //offsetof( ThingTemplate, m_inventoryImage[ INV_IMAGE_ENABLED ] ) }, { "InventoryImageDisabled",	INI::parseAsciiString,	nullptr,		offsetof( ThingTemplate, m_inventoryImage[ INV_IMAGE_DISABLED ] ) },
     //{ "InventoryImageHilite",		INI::parseAsciiString,	nullptr,
     //offsetof( ThingTemplate, m_inventoryImage[ INV_IMAGE_HILITE ] ) }, {
     //"InventoryImagePushed",		INI::parseAsciiString,	nullptr,
     //offsetof( ThingTemplate, m_inventoryImage[ INV_IMAGE_PUSHED ] ) },

     {"UpgradeCameo1", INI::parseAsciiString, nullptr,
      offsetof(ThingTemplate, m_upgradeCameoUpgradeNames[0])},
     {"UpgradeCameo2", INI::parseAsciiString, nullptr,
      offsetof(ThingTemplate, m_upgradeCameoUpgradeNames[1])},
     {"UpgradeCameo3", INI::parseAsciiString, nullptr,
      offsetof(ThingTemplate, m_upgradeCameoUpgradeNames[2])},
     {"UpgradeCameo4", INI::parseAsciiString, nullptr,
      offsetof(ThingTemplate, m_upgradeCameoUpgradeNames[3])},
     {"UpgradeCameo5", INI::parseAsciiString, nullptr,
     ...
     {"VoiceSelect", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate, m_audioarray.m_audio[TTAUDIO_voiceSelect])},
     {"VoiceGroupSelect", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate, m_audioarray.m_audio[TTAUDIO_voiceGroupSelect])},
     {"VoiceMove", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate, m_audioarray.m_audio[TTAUDIO_voiceMove])},
     {"VoiceAttack", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate, m_audioarray.m_audio[TTAUDIO_voiceAttack])},
     {"VoiceEnter", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate, m_audioarray.m_audio[TTAUDIO_voiceEnter])},
     {"VoiceFear", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate, m_audioarray.m_audio[TTAUDIO_voiceFear])},
     {"VoiceSelectElite", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate, m_audioarray.m_audio[TTAUDIO_voiceSelectElite])},
     {"VoiceCreated", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate, m_audioarray.m_audio[TTAUDIO_voiceCreated])},
     {"VoiceTaskUnable", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate, m_audioarray.m_audio[TTAUDIO_voiceTaskUnable])},
     {"VoiceTaskComplete", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate, m_audioarray.m_audio[TTAUDIO_voiceTaskComplete])},
     {"VoiceMeetEnemy", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate, m_audioarray.m_audio[TTAUDIO_voiceMeetEnemy])},
     {"VoiceGarrison", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate, m_audioarray.m_audio[TTAUDIO_voiceGarrison])},
#ifdef ALLOW_SURRENDER
     {"VoiceSurrender", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate, m_audioarray.m_audio[TTAUDIO_voiceSurrender])},
#endif
     {"VoiceDefect", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate, m_audioarray.m_audio[TTAUDIO_voiceDefect])},
     {"VoiceAttackSpecial", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate,
               m_audioarray.m_audio[TTAUDIO_voiceAttackSpecial])},
     {"VoiceAttackAir", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate, m_audioarray.m_audio[TTAUDIO_voiceAttackAir])},
     {"VoiceGuard", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate, m_audioarray.m_audio[TTAUDIO_voiceGuard])},
     {"SoundMoveStart", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate, m_audioarray.m_audio[TTAUDIO_soundMoveStart])},
     {"SoundMoveStartDamaged", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate,
               m_audioarray.m_audio[TTAUDIO_soundMoveStartDamaged])},
     {"SoundMoveLoop", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate, m_audioarray.m_audio[TTAUDIO_soundMoveLoop])},
     {"SoundMoveLoopDamaged", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate,
               m_audioarray.m_audio[TTAUDIO_soundMoveLoopDamaged])},
     {"SoundAmbient", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate, m_audioarray.m_audio[TTAUDIO_soundAmbient])},
     {"SoundAmbientDamaged", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate,
               m_audioarray.m_audio[TTAUDIO_soundAmbientDamaged])},
     {"SoundAmbientReallyDamaged", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate,
               m_audioarray.m_audio[TTAUDIO_soundAmbientReallyDamaged])},
     {"SoundAmbientRubble", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate,
               m_audioarray.m_audio[TTAUDIO_soundAmbientRubble])},
     {"SoundStealthOn", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate, m_audioarray.m_audio[TTAUDIO_soundStealthOn])},
     {"SoundStealthOff", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate, m_audioarray.m_audio[TTAUDIO_soundStealthOff])},
     {"SoundCreated", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate, m_audioarray.m_audio[TTAUDIO_soundCreated])},
     {"SoundOnDamaged", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate, m_audioarray.m_audio[TTAUDIO_soundOnDamaged])},
     {"SoundOnReallyDamaged", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate,
               m_audioarray.m_audio[TTAUDIO_soundOnReallyDamaged])},
     {"SoundEnter", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate, m_audioarray.m_audio[TTAUDIO_soundEnter])},
     {"SoundExit", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate, m_audioarray.m_audio[TTAUDIO_soundExit])},
     {"SoundPromotedVeteran", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate,
               m_audioarray.m_audio[TTAUDIO_soundPromotedVeteran])},
     {"SoundPromotedElite", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate,
               m_audioarray.m_audio[TTAUDIO_soundPromotedElite])},
     {"SoundPromotedHero", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate, m_audioarray.m_audio[TTAUDIO_soundPromotedHero])},
     {"SoundFallingFromPlane", INI::parseDynamicAudioEventRTS, nullptr,
      offsetof(ThingTemplate, m_audioarray.m_audio[TTAUDIO_soundFalling])},

     {"UnitSpecificSounds", ThingTemplate::parsePerUnitSounds, nullptr,
      offsetof(ThingTemplate, m_perUnitSounds)},
     {"UnitSpecificFX", ThingTemplate::parsePerUnitFX, nullptr,
      offsetof(ThingTemplate, m_perUnitFX)},
     {"Scale", INI::parseReal, nullptr, offsetof(ThingTemplate, m_assetScale)},
     {"Geometry", GeometryInfo::parseGeometryType, nullptr,
      offsetof(ThingTemplate, m_geometryInfo)},
     {"GeometryMajorRadius", GeometryInfo::parseGeometryMajorRadius, nullptr,
      offsetof(ThingTemplate, m_geometryInfo)},
     {"GeometryMinorRadius", GeometryInfo::parseGeometryMinorRadius, nullptr,
      offsetof(ThingTemplate, m_geometryInfo)},
     {"GeometryHeight", GeometryInfo::parseGeometryHeight, nullptr,
      offsetof(ThingTemplate, m_geometryInfo)},
     {"GeometryIsSmall", GeometryInfo::parseGeometryIsSmall, nullptr,
      offsetof(ThingTemplate, m_geometryInfo)},
     {"Shadow", INI::parseBitString8, TheShadowNames,
      offsetof(ThingTemplate, m_shadowType)},
     {"ShadowSizeX", INI::parseReal, nullptr,
      offsetof(ThingTemplate, m_shadowSizeX)},
     {"ShadowSizeY", INI::parseReal, nullptr,
      offsetof(ThingTemplate, m_shadowSizeY)},
     {"ShadowOffsetX", INI::parseReal, nullptr,
      offsetof(ThingTemplate, m_shadowOffsetX)},
     {"ShadowOffsetY", INI::parseReal, nullptr,
      offsetof(ThingTemplate, m_shadowOffsetY)},
     {"ShadowTexture", INI::parseAsciiString, nullptr,
      offsetof(ThingTemplate, m_shadowTextureName)},
     {"OcclusionDelay", INI::parseDurationUnsignedInt, nullptr,
     ...
     {"OverrideableByLikeKind", ThingTemplate::OverrideableByLikeKind, nullptr,
      0},

     {"Locomotor", AIUpdateModuleData::parseLocomotorSet, nullptr, 0},
     {"InstanceScaleFuzziness", INI::parseReal, nullptr,
      offsetof(ThingTemplate, m_instanceScaleFuzziness)},
     {"StructureRubbleHeight", INI::parseUnsignedByte, nullptr,
      offsetof(ThingTemplate, m_structureRubbleHeight)},
     {"ThreatValue", INI::parseUnsignedShort, nullptr,
      offsetof(ThingTemplate, m_threatValue)},
     {"MaxSimultaneousOfType", ThingTemplate::parseMaxSimultaneous, nullptr,
      offsetof(ThingTemplate, m_maxSimultaneousOfType)},
     {"MaxSimultaneousLinkKey", NameKeyGenerator::parseStringAsNameKeyType,
      nullptr, offsetof(ThingTemplate, m_maxSimultaneousLinkKey)},
     {"CrusherLevel", INI::parseUnsignedByte, nullptr,
      offsetof(ThingTemplate, m_crusherLevel)},
     {"CrushableLevel", INI::parseUnsignedByte, nullptr,
...
// ------------------------------------------------------------------------------------------------
const ModuleInfo::Nugget *
ModuleInfo::getNuggetWithTag(const AsciiString &tag) const {
...
void ModuleInfo::addModuleInfo(ThingTemplate *thingTemplate,
                               ...
                               Bool inheritable, Bool overrideableByLikeKind) {
...
//-------------------------------------------------------------------------------------------------
Bool ModuleInfo::clearCopiedFromDefaultEntries(
    Int interfaceMask, const AsciiString &newName,
  ...
  while (it != m_info.end()) {
    if ((it->interfaceMask & interfaceMask) != 0 && it->copiedFromDefault) {
      if (it->inheritable) {
        if (it->m_moduleTag.compare("ModuleTag_DefaultAutoHealBehavior") == 0 &&
            !fullTemplate->isTrainable()) {
        ...
        if (oldName ==
                newName // we will dump this instance, since the INI author
                        // requested a specific one of the same class
            || disallowed // or, we just do not Add these special overrideables
                          // to these kinds of templates, so just dump it
            || candidate == FALSE) {
          it = m_info.erase(it);
          ret = true;
        } else
          ++it; // no match, preserve the default instance of this Module for
                // now
      } else // just dump this instance of this Module, since one of the same
             // interface mask has been added by caller
      {
        it = m_info.erase(it);
        ret = true;
      }
...
void ThingTemplate::parseModuleName(INI *ini, void *instance, void *store,
  ...
  try {
    ...
    DEBUG_CRASH(("[LINE: %d - FILE: '%s'] Module tag not found for module '%s' "
                 "on thing template '%s'.  Module tags are required and must "
                 "be unique for all modules within an object definition",
  ...
  if (ini->getLoadType() == INI_LOAD_CREATE_OVERRIDES) {
    if (self->m_moduleParsingMode == MODULEPARSE_ADD_REMOVE_REPLACE) {
      ...
      DEBUG_CRASH(("[LINE: %d - FILE: '%s'] You must use AddModule to add "
                   "modules in override INI files.",
    ...
    //      DEBUG_ASSERTCRASH( FALSE, ("WE ARE CLEARING DEFAULT MODULES FROM A
    //      QUAD CANNON.") );
    ...
    self->m_drawModuleInfo.clearCopiedFromDefaultEntries(interfaceMask,
                                                         tokenStr, self);
    self->m_clientUpdateModuleInfo.clearCopiedFromDefaultEntries(
        interfaceMask, tokenStr, self);
  }

  if (self->m_moduleParsingMode == MODULEPARSE_ADD_REMOVE_REPLACE &&
      self->m_moduleBeingReplacedName.isNotEmpty() &&
      self->m_moduleBeingReplacedName != tokenStr) {
    DEBUG_CRASH(("[LINE: %d - FILE: '%s'] ReplaceModule must replace modules "
                 "with another module of the same type, but you are attempting "
                 "to replace a %s with a %s for Object %s.",
                 ini->getLineNum(), ini->getFilename().str(),
  ...
  if (self->m_moduleParsingMode == MODULEPARSE_ADD_REMOVE_REPLACE &&
    ...
    DEBUG_CRASH(("[LINE: %d - FILE: '%s'] ReplaceModule must specify a new, "
                 "unique tag for the replaced module, but you are not doing so "
                 "for %s (%s) for Object %s.",
                 ini->getLineNum(), ini->getFilename().str(),
                 moduleTagStr.str(), self->m_moduleBeingReplacedName.str(),
                 self->getName().str()));
    throw INI_INVALID_DATA;
  }
...
static void parsePrerequisiteUnit(INI *ini, void *instance, void * /*store*/,
  ...
  for (const char *token = ini->getNextToken(); token != nullptr;
...
//-------------------------------------------------------------------------------------------Static
static void parseArbitraryFXIntoMap(INI *ini, void *instance,
                                    void * /* store */, const void *userData) {
  PerUnitFXMap *mapFX = (PerUnitFXMap *)instance;
  const char *name = (const char *)userData;
  const char *token = ini->getNextToken();
  const FXList *fxl = TheFXListStore->findFXList(token); // could be null!
  DEBUG_ASSERTCRASH(fxl != nullptr || stricmp(token, "None") == 0,
                    ("FXList %s not found!", token));
...
void ThingTemplate::parseRemoveModule(INI *ini, void *instance, void *store,
  ...
  if (!removed) {
    DEBUG_ASSERTCRASH(
        removed,
        ("RemoveModule %s was not found for %s. The game will crash now!",
...
void ThingTemplate::parseReplaceModule(INI *ini, void *instance, void *store,
  ...
  Bool removed = self->removeModuleInfo(modToRemove, removedModuleName);
  if (!removed) {
    DEBUG_CRASH(("[LINE: %d - FILE: '%s'] ReplaceModule %s was not found for "
                 "%s; cannot continue.",
...
//-------------------------------------------------------------------------------------------------
/** mark the module(s) as being "VverrideableByLikeKind". default module will be
 * replaced by any of the exact same class */
//-------------------------------------------------------------------------------------------------
void ThingTemplate::OverrideableByLikeKind(INI *ini, void *instance,
                                           void *store, const void *userData) {
  ThingTemplate *self = (ThingTemplate *)instance;
...
void ArmorTemplateSet::parseArmorTemplateSet(INI *ini) {
  static const FieldParse myFieldParse[] = {
      {"Conditions", ArmorSetFlags::parseFromINI, nullptr,
       offsetof(ArmorTemplateSet, m_types)},
      {"Armor", INI::parseArmorTemplate, nullptr,
       offsetof(ArmorTemplateSet, m_template)},
      {"DamageFX", INI::parseDamageFX, nullptr,
       offsetof(ArmorTemplateSet, m_fx)},
      {nullptr, nullptr, nullptr, 0}};
...
void ThingTemplate::parseMaxSimultaneous(INI *ini, void *instance, void *store,
                                         const void *userData) {
  // Most of the time, this is an UnsignedShort, but sometimes this is the
  // keyword "DeterminedBySuperweaponRestriction"
  const char DETERMINED_BY_SUPERWEAPON_KEYWORD[] =
      "DeterminedBySuperweaponRestriction";

  ThingTemplate *myTemplate = (ThingTemplate *)instance;
  DEBUG_ASSERTCRASH(&myTemplate->m_maxSimultaneousOfType == store,
                    ("Bad store passed to parseMaxSimultaneous"));
...
#define AUDIO_TEST(y)                                                          \
  if (!get##y()->getEventName().isEmpty() &&                                   \
    ...
    DEBUG_ASSERTLOG(TheAudio->isValidAudioEvent(get##y()),                     \
                    ("Invalid Sound '%s' in Object '%s'. (%s?)", #y,           \
...
void ThingTemplate::validate() {
  ...
  if (isKindOf(KINDOF_STRUCTURE) && !isImmobile) {
    DEBUG_CRASH(("Structure %s is not marked immobile, but probably should be "
                 "-- please fix it. (If we ever add mobile structures, this "
                 "debug sniffer will need to be revised.)",
                 getName().str()));
  }

  if (isKindOf(KINDOF_STICK_TO_TERRAIN_SLOPE) && !isImmobile) {
    DEBUG_CRASH(("item %s is marked STICK_TO_TERRAIN_SLOPE but not IMMOBILE -- "
                 "please fix it.",
                 getName().str()));
  }
  ...
  if (isKindOf(KINDOF_STRUCTURE)) {
    if (m_armorTemplateSets.empty() ||
        (m_armorTemplateSets.size() == 1 &&
         m_armorTemplateSets[0].getArmorTemplate() == nullptr)) {
      DEBUG_CRASH(("Structure %s has no armor, but probably should "
                   "(StructureArmor) -- please fix it.)",
                   getName().str()));
    }
    for (ArmorTemplateSetVector::const_iterator it =
...
void ThingTemplate::resolveNames() {
  ...
  // Kris: July 31, 2003
  // NOTE: Make sure that all code in this function supports caching properly.
  // For example,
  //       templates can be partially overridden by map.ini files. When this
  //       happens, strings that have been parsed are looked up, cached, then
  //       cleared. The problem is if a string gets cached, but not overridden,
  //       it will be clear the next time we call this function. so we will want
  //       to make sure we don't NULL out cached data if the string is empty. A
  //       concrete example is overriding an object with prerequisites. We just
  //       override the portrait. So the 1st time we call this function, we get
  //       the standard template data. During this first call, the strings are
  //       looked up, cached, and cleared. Then we override the portrait in the
  //       map.ini. The next time we call this function, we look up all the
  //       strings again. The prereq names didn't used to check for empty
  //       strings so they would NULL out all the previous prereqs the object
  //       had. So be sure to make sure all string lookups don't blindly lookup
  //       things -- check if the string isNotEmpty first!
  ...
  for (i = 0; i < m_prereqInfo.size(); i++) {
    ...
    for (j = 0; j < count; j++) {
      ...
      // %s",tmpls[j]->m_nameString.str(),this->m_nameString.str()));
    }
  }
...
void ThingTemplate::initForLTA(const AsciiString &name) {
  ...
  m_behaviorModuleInfo.addModuleInfo(
      ...
      TheModuleFactory->newModuleDataFromINI(nullptr, "DestroyDie",
  ...
  m_behaviorModuleInfo.addModuleInfo(
      ...
      TheModuleFactory->newModuleDataFromINI(nullptr, "InactiveBody",
                                             MODULETYPE_BEHAVIOR, moduleTag),
  ...
  m_drawModuleInfo.addModuleInfo(
      ...
      TheModuleFactory->newModuleDataFromINI(nullptr, "W3DDefaultDraw",
...
//=============================================================================
const ArmorTemplateSet *
ThingTemplate::findArmorTemplateSet(const ArmorSetFlags &t) const {
  return m_armorTemplateSetFinder.findBestInfo(m_armorTemplateSets, t);
}

//=============================================================================
const WeaponTemplateSet *
ThingTemplate::findWeaponTemplateSet(const WeaponSetFlags &t) const {
...
//-----------------------------------------------------------------------------
const ThingTemplate *
ThingTemplate::getBuildFacilityTemplate(const Player *player) const {
  if (getPrereqCount() > 0) {
...
//-------------------------------------------------------------------------------------------------
const AudioEventRTS *
ThingTemplate::getPerUnitSound(const AsciiString &soundName) const {
...
Bool ThingTemplate::isEquivalentTo(const ThingTemplate *tt) const {
  ...
  // Kris: added case (chassis 2 compared to chassis 3 -- nullptr possible if
  // not reskinned)
...
Int ThingTemplate::calcTimeToBuild(const Player *player) const {
  ...
  if (EnergyPercent > 1.0f)
    EnergyPercent = 1.0f; // getEnergySupplyRatio() returns a true ratio, but we
                          // don't care about excess.
  Real EnergyShort = 1.0f - EnergyPercent; // so I am 20% short
  EnergyShort *=
      TheGlobalData->m_LowEnergyPenaltyModifier; // which is a 40% penalty, or a
                                                 // 10% penalty
  Real penaltyRate = 1.0f - EnergyShort;
  penaltyRate = max(
      penaltyRate,
      TheGlobalData
          ->m_MinLowEnergyProductionSpeed); // bind so 0% does not dead stop you

  if (EnergyPercent < 1.0f) // and make 99% look like 80% (eg) since most of the
                            // time you are down only a little
    penaltyRate =
