...
template<>
const char *ModelConditionFlags::s_bitNameList[] = { "TOPPLED",
																										 "FRONTCRUSHED",
																										 "BACKCRUSHED",
																										 "DAMAGED",
																										 "REALLYDAMAGED",
																										 ...
																										 "RIDER1", // Kris: Added these for different combat-bike riders, but
...
template<>
const char *ArmorSetFlags::s_bitNameList[] = { "VETERAN",
																							 "ELITE",
																							 "HERO",
																							 "PLAYER_UPGRADE",
