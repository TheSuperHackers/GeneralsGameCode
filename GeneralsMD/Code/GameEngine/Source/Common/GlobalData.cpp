...
GlobalData::GlobalData()
{
	...
	if (::SHGetSpecialFolderPath(NULL, temp, CSIDL_PERSONAL, true))
	{
		...
		if (!GetStringFromRegistry("", "UserDataLeafName", leafName))
		{
			...
			// [MH] had to remove this, otherwise mapcache build step won't run... DEBUG_CRASH( ( "Could not find registry key
			// UserDataLeafName; defaulting to \"Command and Conquer Generals Zero Hour Data\" " ) );
