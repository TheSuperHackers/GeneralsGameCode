...
static const FieldParse TheGlobalLanguageDataFieldParseTable[] = {
	...
	//{	"UnicodeFontFileName",							INI::parseAsciiString,NULL,									offsetof( GlobalLanguage,
...
void INI::parseLanguageDefinition(INI *ini)
{
	if (!TheGlobalLanguageData)
	{
		DEBUG_ASSERTCRASH(
				...
				("INI::parseLanguageDefinition - TheGlobalLanguage Data is not around, please create it before trying to parse the "
				 "ini file."));
		return;
	} // end if
