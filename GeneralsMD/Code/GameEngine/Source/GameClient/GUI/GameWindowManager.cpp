...
//	UnsignedByte alpha = 200;
	...
	window = TheWindowManager->winCreate( nullptr, statusFlags, 0, 0, 100, 100, nullptr, nullptr );
	...
	window = TheWindowManager->winCreate( window, statusFlags, 10, 10, 50, 50, nullptr, nullptr );
	window->winSetInputFunc( testGrab );
	...
	window = TheWindowManager->gogoGadgetPushButton( nullptr,
	...
	window = TheWindowManager->gogoGadgetCheckbox( nullptr,
																								 WIN_STATUS_ENABLED |
																								 WIN_STATUS_IMAGE,
																								 200, 150,
																								 100, 30,
	...
	window = TheWindowManager->winCreate( nullptr, WIN_STATUS_ENABLED | WIN_STATUS_DRAGABLE,
	...
	window = TheWindowManager->gogoGadgetListBox( nullptr,
																								WIN_STATUS_ENABLED,
																								200, 250,
																								100, 100,
																								&instData,
	...
	window = TheWindowManager->gogoGadgetSlider( nullptr,
																							 WIN_STATUS_ENABLED,
																							 360, 250,
																							 11, 100,
																							 &instData,
	...
	window = TheWindowManager->gogoGadgetProgressBar( nullptr,
																									 WIN_STATUS_ENABLED,
																									 200, 450,
																									 250, 15,
																									 &instData, nullptr, TRUE );
	...
	window = TheWindowManager->gogoGadgetStaticText( nullptr,
																									 WIN_STATUS_ENABLED,
																									 200, 490,
																									 300, 25,
																									 &instData,
	...
	window = TheWindowManager->gogoGadgetTextEntry( nullptr,
																									 WIN_STATUS_ENABLED,
																									 450, 270,
																									 400, 30,
																									 &instData,
