...
//=============================================================================
WindowMsgHandledType GadgetTabControlInput(
...
//=============================================================================
WindowMsgHandledType GadgetTabControlSystem(
		GameWindow *tabControl,
		UnsignedInt msg,
		WindowMsgData mData1,
		WindowMsgData mData2)
	...
	for (Int paneIndex = 0; paneIndex < NUM_TAB_PANES; paneIndex++)
	{
		if (tabData->subPanes[paneIndex] == NULL) // This one is blank
		{
			tabData->subPanes[paneIndex] =
					TheWindowManager
							->winCreate(tabControl, WIN_STATUS_NONE, x, y, width, height, PassSelectedButtonsToParentSystem, NULL);
