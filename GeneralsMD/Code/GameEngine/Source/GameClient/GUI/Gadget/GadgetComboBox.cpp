...
//=============================================================================
WindowMsgHandledType GadgetComboBoxInput(GameWindow *window, UnsignedInt msg, WindowMsgData mData1, WindowMsgData mData2)
{
        ...
        case GWM_LEFT_UP:
        {
            ...
            if (listBox)
            {
                ...
                if (listBox->winIsHidden())
                {
                    ...
                    newSize.y =
                        ((TheWindowManager->winFontHeight(listInstData->getFont())) * multiplier) + multiplier * 2 + 4;
...
WindowMsgHandledType GadgetComboBoxSystem(GameWindow *window, UnsignedInt msg, WindowMsgData mData1, WindowMsgData mData2)
{
    ...
    switch (msg)
    {
        ...
        {
            TheWindowManager->winSendSystemMsg(window->winGetOwner(), GCM_UPDATE_TEXT, (WindowMsgData)window, 0);
        ...
        case GEM_EDIT_DONE:
        {
            ...
            {
                HideListBox(window);
                TheWindowManager->winSendSystemMsg(window->winGetOwner(), GCM_SELECTED, (WindowMsgData)window, 0);
            }
            break;
        }
        // ------------------------------------------------------------------------
