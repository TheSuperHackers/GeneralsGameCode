...
void FlashTransition::update(Int frame)
{
    ...
    if (frame < FLASHTRANSITION_START || frame > FLASHTRANSITION_END)
    {
        DEBUG_ASSERTCRASH(
            FALSE,
            ("FlashTransition::update - Frame is out of the range the this update can handle %d", frame));
        return;
    }
    switch (frame)
    {
...
void ButtonFlashTransition::update(Int frame)
{
    ...
    if (frame < BUTTONFLASHTRANSITION_START || frame > BUTTONFLASHTRANSITION_END)
    {
        DEBUG_ASSERTCRASH(
            FALSE,
            ("ButtonFlashTransition::update - Frame is out of the range the this update can handle %d", frame));
        return;
    }
    switch (frame)
    {
...
void FadeTransition::update(Int frame)
{
    ...
    if (frame < FADETRANSITION_START || frame > FADETRANSITION_END)
    {
        DEBUG_ASSERTCRASH(
            FALSE,
            ("FadeTransition::update - Frame is out of the range the this update can handle %d", frame));
        return;
    }
    switch (frame)
    {
...
void ScaleUpTransition::update(Int frame)
{
    ...
    if (frame < SCALEUPTRANSITION_START || frame > SCALEUPTRANSITION_END)
    {
        DEBUG_ASSERTCRASH(
            FALSE,
            ("ScaleUpTransition::update - Frame is out of the range the this update can handle %d", frame));
        return;
    }
    switch (frame)
    {
...
void ScoreScaleUpTransition::update(Int frame)
{
    ...
    if (frame < SCORESCALEUPTRANSITION_START || frame > SCORESCALEUPTRANSITION_END)
    {
        DEBUG_ASSERTCRASH(
            FALSE,
            ("ScoreScaleUpTransition::update - Frame is out of the range the this update can handle %d", frame));
        return;
    }
    switch (frame)
    {
...
void MainMenuScaleUpTransition::update(Int frame)
{
    ...
    if (frame < MAINMENUSCALEUPTRANSITION_START || frame > MAINMENUSCALEUPTRANSITION_END)
    {
        DEBUG_ASSERTCRASH(
            FALSE,
            ("MainMenuScaleUpTransition::update - Frame is out of the range the this update can handle %d", frame));
        return;
    }
    switch (frame)
    {
...
void MainMenuMediumScaleUpTransition::update(Int frame)
{
    ...
    if (frame < MAINMENUMEDIUMSCALEUPTRANSITION_START || frame > MAINMENUMEDIUMSCALEUPTRANSITION_END)
    {
        DEBUG_ASSERTCRASH(
            FALSE,
            ("MainMenuMediumScaleUpTransition::update - Frame is out of the range the this update can handle %d", frame));
        return;
    }
    switch (frame)
    {
...
void MainMenuSmallScaleDownTransition::update(Int frame)
{
    ...
    if (frame < MAINMENUSMALLSCALEDOWNTRANSITION_START || frame > MAINMENUSMALLSCALEDOWNTRANSITION_END)
    {
        DEBUG_ASSERTCRASH(
            FALSE,
            ("MainMenuSmallScaleDownTransition::update - Frame is out of the range the this update can handle %d", frame));
        return;
    }
    switch (frame)
    {
...
void TextTypeTransition::update(Int frame)
{
    ...
    if (frame < TEXTTYPETRANSITION_START || frame > TEXTTYPETRANSITION_END)
    {
        DEBUG_ASSERTCRASH(
            FALSE,
            ("TextTypeTransition::update - Frame is out of the range the this update can handle %d", frame));
        return;
    }
    switch (frame)
    {
...
void CountUpTransition::update(Int frame)
{
    ...
    if (frame < COUNTUPTRANSITION_START || frame > COUNTUPTRANSITION_END)
    {
        DEBUG_ASSERTCRASH(
            FALSE,
            ("CountUpTransition::update - Frame is out of the range the this update can handle %d", frame));
        return;
    }
    switch (frame)
    {
...
void ScreenFadeTransition::update(Int frame)
{
    ...
    if (frame < SCREENFADETRANSITION_START || frame > SCREENFADETRANSITION_END)
    {
        DEBUG_ASSERTCRASH(
            FALSE,
            ("ScreenFadeTransition::update - Frame is out of the range the this update can handle %d", frame));
        return;
    }
    switch (frame)
    {
...
void ControlBarArrowTransition::update(Int frame)
{
    ...
    if (frame < CONTROLBARARROWTRANSITION_START || frame > CONTROLBARARROWTRANSITION_END)
    {
        DEBUG_ASSERTCRASH(
            FALSE,
            ("ControlBarArrowTransition::update - Frame is out of the range the this update can handle %d", frame));
        return;
    }
    switch (frame)
    {
...
void FullFadeTransition::update(Int frame)
{
    ...
    if (frame < FULLFADETRANSITION_START || frame > FULLFADETRANSITION_END)
    {
        DEBUG_ASSERTCRASH(
            FALSE,
            ("FullFadeTransition::update - Frame is out of the range the this update can handle %d", frame));
        return;
    }
    switch (frame)
    {
...
void TextOnFrameTransition::update(Int frame)
{
    if (frame < TEXTONFRAMETRANSITION_START || frame > TEXTONFRAMETRANSITION_END)
    {
        DEBUG_ASSERTCRASH(
            FALSE,
            ("TextOnFrameTransition::update - Frame is out of the range the this update can handle %d", frame));
        return;
    }
    switch (frame)
    {
...
void ReverseSoundTransition::update(Int frame)
{
    if (frame < REVERSESOUNDTRANSITION_START || frame > REVERSESOUNDTRANSITION_END)
    {
        DEBUG_ASSERTCRASH(
            FALSE,
            ("ReverseSoundTransition::update - Frame is out of the range the this update can handle %d", frame));
        return;
    }
    switch (frame)
    {
