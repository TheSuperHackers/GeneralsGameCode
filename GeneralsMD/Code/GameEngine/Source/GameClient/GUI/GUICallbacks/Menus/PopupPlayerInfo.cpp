...
static const char *rankNames[] = {
  "Private", "Corporal", "Sergeant", "Lieutenant", "Captain", "Major", "Colonel", "General", "Brigadier", "Commander",
};
  ...
  else
  {
    ...
    else if (BitIsSet(battleHonor, BATTLE_HONOR_DOMINATION_ONLINE))
    {
      if (extraValue >= 10000)
        ...
        TheMouse
            ->setCursorTooltip(TheGameText->fetch("TOOLTIP:BattleHonorDominationOnlineDisabled"), -1, NULL, tooltipWidth);
    }
  }
}
