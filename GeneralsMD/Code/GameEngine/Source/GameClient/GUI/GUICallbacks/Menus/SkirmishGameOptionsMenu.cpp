...
void InitSkirmishGameGadgets(void)
{
    ...
    for (; i < MAX_SLOTS; i++)
    {
        ...
        comboBoxPlayerTemplate[i] =
            TheWindowManager->winGetWindowFromId(parentSkirmishGameOptions, comboBoxPlayerTemplateID[i]);
        ...
        buttonMapStartPosition[i] =
            TheWindowManager->winGetWindowFromId(parentSkirmishGameOptions, buttonMapStartPositionID[i]);
