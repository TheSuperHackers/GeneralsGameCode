...
void InitLanGameGadgets(void)
{
	...
	listboxChatWindowLanGameID =
			TheNameKeyGenerator->nameToKey(AsciiString("LanGameOptionsMenu.wnd:ListboxChatWindowLanGame"));
	...
	checkboxLimitSuperweaponsID =
			TheNameKeyGenerator->nameToKey(AsciiString("LanGameOptionsMenu.wnd:CheckboxLimitSuperweapons"));
...
//-------------------------------------------------------------------------------------------------
WindowMsgHandledType LanGameOptionsMenuInput(GameWindow *window, UnsignedInt msg, WindowMsgData mData1, WindowMsgData mData2)
{
	switch (msg)
	{
		// --------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------
WindowMsgHandledType LanGameOptionsMenuSystem(
		GameWindow *window,
		UnsignedInt msg,
