    ...
    void *data)
{
    ...
    if (!strcmp(type, "PUSHBUTTON"))
    {
        ...
        window =
            TheWindowManager->gogoGadgetPushButton(parent, status, x, y, width, height, instData, instData->m_font, FALSE);
    }
    else if (!strcmp(type, "RADIOBUTTON"))
    {
    ...
    else if (!strcmp(type, "CHECKBOX"))
    {
        ...
        window =
            TheWindowManager->gogoGadgetCheckbox(parent, status, x, y, width, height, instData, instData->m_font, FALSE);
    }
    else if (!strcmp(type, "TABCONTROL"))
    {
    ...
    else if (!strcmp(type, "VERTSLIDER"))
    {
        ...
        window = TheWindowManager
                     ->gogoGadgetSlider(parent, status, x, y, width, height, instData, sData, instData->m_font, FALSE);
    ...
    else if (!strcmp(type, "SCROLLLISTBOX"))
    {
        ...
        window = TheWindowManager
                     ->gogoGadgetListBox(parent, status, x, y, width, height, instData, lData, instData->m_font, FALSE);
    ...
    else if (!strcmp(type, "COMBOBOX"))
    {
        ...
        window = TheWindowManager
                     ->gogoGadgetComboBox(parent, status, x, y, width, height, instData, cData, instData->m_font, FALSE);
    ...
    else if (!strcmp(type, "ENTRYFIELD"))
    {
        ...
        window = TheWindowManager
                     ->gogoGadgetTextEntry(parent, status, x, y, width, height, instData, eData, instData->m_font, FALSE);
    }
    else if (!strcmp(type, "STATICTEXT"))
    {
    ...
    else if (!strcmp(type, "PROGRESSBAR"))
    {
        ...
        window =
            TheWindowManager->gogoGadgetProgressBar(parent, status, x, y, width, height, instData, instData->m_font, FALSE);
    }
