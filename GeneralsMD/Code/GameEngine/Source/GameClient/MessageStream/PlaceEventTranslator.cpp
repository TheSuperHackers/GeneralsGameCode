					...
					if (builderObj)
					{
						...
						if (puInterface)
						{
							...
							if (commandButton)
							{
								...
								placeMsg->appendIntegerArgument(commandButton->getSpecialPowerTemplate()->getID()); // The ID of the special
																																																		// power template.
								...
								placeMsg->appendObjectIDArgument(builderObj->getID()); // The source object responsible for firing the
																																			 // special.
