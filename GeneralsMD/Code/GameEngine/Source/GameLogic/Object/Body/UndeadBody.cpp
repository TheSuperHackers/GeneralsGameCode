...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
UndeadBody::UndeadBody(Thing *thing, const ModuleData *moduleData) : ActiveBody(thing, moduleData)
{
...
void UndeadBody::attemptDamage(DamageInfo *damageInfo)
{
	...
	if (damageInfo->in.m_damageType != DAMAGE_UNRESISTABLE && !m_isSecondLife && damageInfo->in.m_amount >= getHealth()
