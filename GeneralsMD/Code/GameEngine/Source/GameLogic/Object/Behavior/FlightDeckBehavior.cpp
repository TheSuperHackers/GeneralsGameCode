...
void FlightDeckBehaviorModuleData::buildFieldParse(MultiIniFieldParse &p)
{
    ...
    static const FieldParse dataFieldParse[] = {
        ...
        {"Runway1Spaces",
         ...
         NULL,
         offsetof(FlightDeckBehaviorModuleData, m_runwayInfo[0].m_spacesBoneNames)},
        {"Runway1Takeoff",
         parseRunwayStrip,
         NULL,
         offsetof(FlightDeckBehaviorModuleData, m_runwayInfo[0].m_takeoffBoneNames)},
        {"Runway1Landing",
         parseRunwayStrip,
         NULL,
         offsetof(FlightDeckBehaviorModuleData, m_runwayInfo[0].m_landingBoneNames)},
        {"Runway1Taxi",
         INI::parseAsciiStringVector,
         NULL,
         offsetof(FlightDeckBehaviorModuleData, m_runwayInfo[0].m_taxiBoneNames)},
        {"Runway1Creation",
         INI::parseAsciiStringVector,
         NULL,
         offsetof(FlightDeckBehaviorModuleData, m_runwayInfo[0].m_creationBoneNames)},
        {"Runway1CatapultSystem",
         INI::parseParticleSystemTemplate,
         NULL,
         offsetof(FlightDeckBehaviorModuleData, m_runwayInfo[0].m_catapultParticleSystem)},

        {"Runway2Spaces",
         INI::parseAsciiStringVector,
         NULL,
         offsetof(FlightDeckBehaviorModuleData, m_runwayInfo[1].m_spacesBoneNames)},
        {"Runway2Takeoff",
         parseRunwayStrip,
         NULL,
         offsetof(FlightDeckBehaviorModuleData, m_runwayInfo[1].m_takeoffBoneNames)},
        {"Runway2Landing",
         parseRunwayStrip,
         NULL,
         offsetof(FlightDeckBehaviorModuleData, m_runwayInfo[1].m_landingBoneNames)},
        {"Runway2Taxi",
         INI::parseAsciiStringVector,
         NULL,
         offsetof(FlightDeckBehaviorModuleData, m_runwayInfo[1].m_taxiBoneNames)},
        {"Runway2Creation",
         INI::parseAsciiStringVector,
         NULL,
         offsetof(FlightDeckBehaviorModuleData, m_runwayInfo[1].m_creationBoneNames)},
        {"Runway2CatapultSystem",
         INI::parseParticleSystemTemplate,
         NULL,
         offsetof(FlightDeckBehaviorModuleData, m_runwayInfo[1].m_catapultParticleSystem)},
        ...
        {"ParkingCleanupPeriod",
         ...
         NULL,
         offsetof(FlightDeckBehaviorModuleData, m_cleanupFrames)},
        {"HumanFollowPeriod",
         INI::parseDurationUnsignedInt,
         NULL,
         offsetof(FlightDeckBehaviorModuleData, m_humanFollowFrames)},
        {"PayloadTemplate", INI::parseAsciiString, NULL, offsetof(FlightDeckBehaviorModuleData, m_thingTemplateName)},
        {"ReplacementDelay",
         INI::parseDurationUnsignedInt,
         NULL,
         offsetof(FlightDeckBehaviorModuleData, m_replacementFrames)},
        {"DockAnimationDelay",
         INI::parseDurationUnsignedInt,
         NULL,
         offsetof(FlightDeckBehaviorModuleData, m_dockAnimationFrames)},
        ...
        {"CatapultFireDelay",
         INI::parseDurationUnsignedInt,
         NULL,
         offsetof(FlightDeckBehaviorModuleData, m_catapultFireFrames)},
...
UpdateSleepTime FlightDeckBehavior::update()
{
    ...
    for (int i = 0; i < data->m_numCols; i++)
    {
        ...
        if (jet && !isAbleToGiveUpParkingSpace(jet) && isInPositionToTakeoff(*jet) && hasTakeoffOrders())
        {
            if (m_nextLaunchWaveFrame[i] <= now)
            {
                ...
                if (!m_rampUp[i])
                {
                    ...
                    //****MAX_RUNWAYS***** if defined beyond 3, then this code will need to be rewritten or more
                    //modelcondition flags will
                    //                     need to be added.
                    ModelConditionFlagType opening =
                        (ModelConditionFlagType)(MODELCONDITION_DOOR_2_OPENING + i * NUM_MODELCONDITION_DOOR_STATES);
                    ModelConditionFlagType closing =
                        (ModelConditionFlagType)(MODELCONDITION_DOOR_2_CLOSING + i * NUM_MODELCONDITION_DOOR_STATES);
        ...
        {
            ParticleSystem *ps =
                TheParticleSystemManager->createParticleSystem(data->m_runwayInfo[i].m_catapultParticleSystem);
        ...
        {
            m_rampUp[i] = FALSE;
            //****MAX_RUNWAYS***** if defined beyond 3, then this code will need to be rewritten or more modelcondition flags
            //will
            //                     need to be added.
            ModelConditionFlagType opening =
                (ModelConditionFlagType)(MODELCONDITION_DOOR_2_OPENING + i * NUM_MODELCONDITION_DOOR_STATES);
...
void FlightDeckBehavior::exitObjectViaDoor(Object *newObj, ExitDoorType exitDoor) ///< Here is the thing I want you to exit
{
    ...
    if (!reserveSpace(
            newObj->getID(),
            parkingOffset,
            &ppinfo)) //&loc, &orient, NULL, NULL, NULL, NULL, &hangarInternal, &hangOrient))
    {
