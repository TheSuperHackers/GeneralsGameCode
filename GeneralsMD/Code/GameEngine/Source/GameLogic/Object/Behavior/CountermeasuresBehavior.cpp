...
ObjectID CountermeasuresBehavior::calculateCountermeasureToDivertTo(const Object &victim)
{
	...
	// behavior The code now iterates through all flares in the volley and selects the nearest one to the weapon as intended in
	// the original EA code This can slightly change behavior but does not significantly impact the overall survivability of
	// the aircraft
