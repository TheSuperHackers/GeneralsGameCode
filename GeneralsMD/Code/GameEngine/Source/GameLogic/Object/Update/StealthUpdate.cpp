...
void StealthUpdate::changeVisualDisguise()
{
	...
	else if (m_disguiseAsPlayerIndex != -1)
	{
		...
		// This originally caused no runtime crash because the new drawable is allocated at the same address as the previously
		// deleted drawable via the MemoryPoolBlob.
