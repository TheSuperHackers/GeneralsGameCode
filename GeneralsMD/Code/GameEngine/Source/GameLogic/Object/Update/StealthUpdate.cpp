...
void StealthUpdateModuleData::buildFieldParse(MultiIniFieldParse &p)
{
    ...
    static const FieldParse dataFieldParse[] = {
        ...
        {"StealthForbiddenConditions",
         ...
         TheStealthLevelNames,
         offsetof(StealthUpdateModuleData, m_stealthLevel)},
        {"HintDetectableConditions",
         ObjectStatusMaskType::parseFromINI,
         NULL,
        ...
        {"OrderIdleEnemiesToAttackMeUponReveal",
         INI::parseBool,
         NULL,
         offsetof(StealthUpdateModuleData, m_orderIdleEnemiesToAttackMeUponReveal)},
        ...
        {"EnemyDetectionEvaEvent",
         ...
         NULL,
         offsetof(StealthUpdateModuleData, m_enemyDetectionEvaEvent)},
        {"OwnDetectionEvaEvent",
         Eva::parseEvaMessageFromIni,
         NULL,
         offsetof(StealthUpdateModuleData, m_ownDetectionEvaEvent)},
        {"BlackMarketCheckDelay",
         INI::parseDurationUnsignedInt,
         NULL,
         offsetof(StealthUpdateModuleData, m_blackMarketCheckFrames)},
...
Bool StealthUpdate::allowedToStealth(Object *stealthOwner) const
{
    ...
    // Do a quick preliminary test to see if we are restricted by firing particular weapons and we fired a shot last frame or
    // this frame.
...
void StealthUpdate::changeVisualDisguise()
{
    ...
    if (m_disguiseAsTemplate)
    {
        ...
        if (draw)
        {
            ...
            if (self->getControllingPlayer()->getRelationship(clientPlayer->getDefaultTeam()) != ALLIES
    ...
    else if (m_disguiseAsPlayerIndex != -1)
    {
        ...
        // This originally caused no runtime crash because the new drawable is allocated at the same address as the
        // previously deleted drawable via the MemoryPoolBlob.
