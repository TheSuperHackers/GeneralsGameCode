...
/*static*/ void BattlePlanUpdateModuleData::buildFieldParse(MultiIniFieldParse &p)
{
    ...
    static const FieldParse dataFieldParse[] = {
        ...
        {"SearchAndDestroyPlanAnimationTime",
         INI::parseDurationUnsignedInt,
         NULL,
         offsetof(BattlePlanUpdateModuleData, m_searchAndDestroyPlanAnimationFrames)},
        {"TransitionIdleTime",
         INI::parseDurationUnsignedInt,
         NULL,
        ...
        {"SearchAndDestroyAnnouncementName",
         INI::parseAsciiString,
         NULL,
         offsetof(BattlePlanUpdateModuleData, m_searchAndDestroyAnnouncementName)},
        ...
        {"SearchAndDestroyPlanSightRangeScalar",
         INI::parseReal,
         NULL,
         offsetof(BattlePlanUpdateModuleData, m_searchAndDestroySightRangeScalar)},

        {"StrategyCenterSearchAndDestroySightRangeScalar",
         INI::parseReal,
         NULL,
         offsetof(BattlePlanUpdateModuleData, m_strategyCenterSearchAndDestroySightRangeScalar)},
        {"StrategyCenterSearchAndDestroyDetectsStealth",
         INI::parseBool,
         NULL,
         offsetof(BattlePlanUpdateModuleData, m_strategyCenterSearchAndDestroyDetectsStealth)},
        {"StrategyCenterHoldTheLineMaxHealthScalar",
         INI::parseReal,
         NULL,
         offsetof(BattlePlanUpdateModuleData, m_strategyCenterHoldTheLineMaxHealthScalar)},
        {"StrategyCenterHoldTheLineMaxHealthChangeType",
         INI::parseIndexList,
         TheMaxHealthChangeTypeNames,
         offsetof(BattlePlanUpdateModuleData, m_strategyCenterHoldTheLineMaxHealthChangeType)},
...
BattlePlanUpdate::BattlePlanUpdate(Thing *thing, const ModuleData *moduleData) :
    SpecialPowerUpdateModule(thing, moduleData), m_bonuses(NULL)
{
...
void BattlePlanUpdate::onObjectCreated()
{
    ...
    {
        DEBUG_CRASH(
            ("%s object's BattlePlanUpdate lacks access to the SpecialPowerTemplate. Needs to be specified in ini.",
...
void BattlePlanUpdate::createVisionObject()
{
    ...
    DEBUG_ASSERTCRASH(tt, ("BattlePlanUpdate::setStatus - Invalid vision object name '%s'", data->m_visionObjectName.str()));
...
void BattlePlanUpdate::setStatus(TransitionStatus newStatus)
{
    ...
    switch (newStatus)
    {
        ...
        case TRANSITIONSTATUS_UNPACKING:
        {
            ...
            TheRadar->createPlayerEvent(obj->getControllingPlayer(), obj->getPosition(), RADAR_EVENT_BATTLE_PLAN);
        ...
        switch (m_planAffectingArmy)
        {
            ...
            case PLANSTATUS_HOLDTHELINE:
            {
                ...
                if (data->m_strategyCenterHoldTheLineMaxHealthScalar != 1.0f)
                {
                    ...
                    body->setMaxHealth(
                        body->getMaxHealth() * 1.0f / data->m_strategyCenterHoldTheLineMaxHealthScalar,
            ...
            case PLANSTATUS_SEARCHANDDESTROY:
            {
                ...
                {
                    obj->setVisionRange(
                        obj->getVisionRange() * 1.0f / data->m_strategyCenterSearchAndDestroySightRangeScalar);
                    obj->setShroudClearingRange(
                        obj->getShroudClearingRange() * 1.0f / data->m_strategyCenterSearchAndDestroySightRangeScalar);
                }
                ...
                if (data->m_strategyCenterSearchAndDestroyDetectsStealth)
                {
                    ...
                    StealthDetectorUpdate *update =
                        (StealthDetectorUpdate *)obj->findUpdateModule(key_StealthDetectorUpdate);
                    if (update)
                    {
        ...
        switch (plan)
        {
            ...
            case PLANSTATUS_HOLDTHELINE:
                ...
                if (data->m_strategyCenterHoldTheLineMaxHealthScalar)
                {
                    BodyModuleInterface *body = obj->getBodyModule();
                    body->setMaxHealth(
                        body->getMaxHealth() * data->m_strategyCenterHoldTheLineMaxHealthScalar,
                        data->m_strategyCenterHoldTheLineMaxHealthChangeType);
                }
            ...
            case PLANSTATUS_SEARCHANDDESTROY:
                ...
                if (data->m_strategyCenterSearchAndDestroySightRangeScalar != 1.0f)
                {
                    ...
                    obj->setShroudClearingRange(
                        obj->getShroudClearingRange() * data->m_strategyCenterSearchAndDestroySightRangeScalar);
                }
