...
/*static*/ void HelicopterSlowDeathBehaviorModuleData::buildFieldParse(MultiIniFieldParse &p)
{
  ...
  static const FieldParse dataFieldParse[] = {
    { "SpiralOrbitTurnRate",
      INI::parseAngularVelocityReal,
      NULL,
      offsetof(HelicopterSlowDeathBehaviorModuleData, m_spiralOrbitTurnRate) },
    { "SpiralOrbitForwardSpeed",
      INI::parseVelocityReal,
      NULL,
      offsetof(HelicopterSlowDeathBehaviorModuleData, m_spiralOrbitForwardSpeed) },
    { "SpiralOrbitForwardSpeedDamping",
      INI::parseReal,
      NULL,
      offsetof(HelicopterSlowDeathBehaviorModuleData, m_spiralOrbitForwardSpeedDamping) },
    ...
    { "DelayFromGroundToFinalDeath",
      INI::parseDurationReal,
      NULL,
      offsetof(HelicopterSlowDeathBehaviorModuleData, m_delayFromGroundToFinalDeath) },
    { "FinalRubbleObject",
      INI::parseAsciiString,
      NULL,
...
void HelicopterSlowDeathBehavior::beginSlowDeath(const DamageInfo *damageInfo)
{
  ...
  m_bladeFlyOffFrame = GameLogicRandomValueReal(modData->m_minBladeFlyOffDelay, modData->m_maxBladeFlyOffDelay);
...
UpdateSleepTime HelicopterSlowDeathBehavior::update(void)
{
  ...
  if (m_hitGroundFrame == 0)
  {
    ...
    DEBUG_ASSERTCRASH(
        physics,
        ("HelicopterSlowDeathBehavior: object '%s' does not have a physics module", copter->getTemplate()->getName().str()));
    ...
    if (m_bladeFlyOffFrame > 0)
    {
      ...
      if (m_bladeFlyOffFrame <= 0)
      {
        ...
        //			const ObjectCreationList *ocl = TheObjectCreationListStore->findObjectCreationList(
  ...
  if (m_hitGroundFrame && TheGameLogic->getFrame() - m_hitGroundFrame > modData->m_delayFromGroundToFinalDeath)
  {
    // make effect
