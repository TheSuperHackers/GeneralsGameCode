...
static void parseOCL(INI *ini, void *instance, void * /*store*/, const void * /*userData*/)
{
    ...
    StructureTopplePhaseType stphase =
        (StructureTopplePhaseType)INI::scanIndexList(ini->getNextToken(), TheStructureTopplePhaseNames);
...
void StructureToppleUpdate::beginStructureTopple(const DamageInfo *damageInfo)
{
    ...
    if (d)
    {
        ...
        Real averageRadius =
            (building->getGeometryInfo().getMajorRadius() + building->getGeometryInfo().getMinorRadius()) / 2;
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
void StructureToppleUpdate::doDamageLine(
    Object *building,
