...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
enum UpgradeStatusType CPP_11( : Int){ UPGRADE_STATUS_INVALID = 0, UPGRADE_STATUS_IN_PRODUCTION, UPGRADE_STATUS_COMPLETE };
...
inline Bool TEST_UPGRADE_MASK_MULTI(
		const UpgradeMaskType &m,
		const UpgradeMaskType &mustBeSet,
		const UpgradeMaskType &mustBeClear)
{
...
public:
	...
	Int calcTimeToBuild(Player *player) const; ///< time in logic frames it will take this player to "build" this
																						 ///< UpgradeTemplate
...
protected:
	...
	AcademyClassificationType m_academyClassificationType; ///< A value used by the academy to evaluate advice based on what
																												 ///< players do.
