...
class UpgradeTemplate : public MemoryPoolObject
{
  ...
  Int calcTimeToBuild(
      Player *player) const; ///< time in logic frames it will take this player to "build" this UpgradeTemplate
  ...
  AcademyClassificationType
      m_academyClassificationType; ///< A value used by the academy to evaluate advice based on what players do.
