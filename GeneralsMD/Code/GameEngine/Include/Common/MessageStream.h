...
public:
	...
	enum Type
	{
		...
		MSG_META_DEBUG_DUMP_ALL_PLAYER_OBJECTS, ///< Dump numbers of objects owned by each player to the script debug window, and
		...
		MSG_DO_FORCE_ATTACK_OBJECT_HINT, ///< (victim objectID) If clicked, an attack would be ordered, "Current Selection" is
																		 ///< assumed
		MSG_DO_FORCE_ATTACK_GROUND_HINT, ///< (victim objectID) If clicked, an attack would be ordered, "Current Selection" is
																		 ///< assumed
		...
		*/
		...
		MSG_BEGIN_DEBUG_NETWORK_MESSAGES = 1900, ///< network messages that exist only in debug/internal builds. all grouped
																						 ///< separately.
...
public:
	...
	virtual void insertMessage(GameMessage *msg, GameMessage *messageToInsertAfter); // Insert message after
																																									 // messageToInsertAfter.
...
public:
	...
	virtual GameMessage *insertMessage(GameMessage::Type type, GameMessage *messageToInsertAfter); // Insert message after
																																																 // messageToInsertAfter.
