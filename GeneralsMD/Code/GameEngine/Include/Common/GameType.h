...
enum ObjectID CPP_11( : Int){ INVALID_ID = 0, FORCE_OBJECTID_TO_LONG_SIZE = 0x7ffffff };

/// A unique, generic "identifier" used to access Drawables.
enum DrawableID CPP_11( : Int){ INVALID_DRAWABLE_ID = 0, FORCE_DRAWABLEID_TO_LONG_SIZE = 0x7ffffff };

/// A unique, generic "identifier" used to identify player specified formations.
enum FormationID CPP_11( : Int){ NO_FORMATION_ID = 0, // Unit is not a member of any formation
...
enum TimeOfDay CPP_11( : Int){
	TIME_OF_DAY_INVALID = 0, TIME_OF_DAY_FIRST = 1, TIME_OF_DAY_MORNING = TIME_OF_DAY_FIRST,
...
enum Scorches CPP_11( : Int){ SCORCH_1 = 0,
															SCORCH_2 = 1,
															SCORCH_3 = 2,
															SCORCH_4 = 3,
															SHADOW_SCORCH = 4,
