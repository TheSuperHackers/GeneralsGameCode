...
class BuildAssistant : public SubsystemInterface
{
  ...
  enum LocalLegalToBuildOptions
  {
    ...
    NO_OBJECT_OVERLAP =
        0X00000004, ///< Can't overlap enemy objects, or locally controled objects that can't move out of the way
    ...
    FAIL_STEALTHED_WITHOUT_FEEDBACK =
        0x00000080 ///< USE WITH IGNORE_STEALTHED except it will fail without BIB feedback (when clicking to place).
  };
