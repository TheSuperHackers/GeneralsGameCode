...
/** Object status types */
//-------------------------------------------------------------------------------------------------
enum ObjectStatusTypes CPP_11( : Int){ // These are saved. Do not insert or remove any!

																			 OBJECT_STATUS_NONE, ///< no status bit
																			 OBJECT_STATUS_DESTROYED, ///< has been destroyed, pending delete
																			 OBJECT_STATUS_CAN_ATTACK, ///< used by garrissoned buildings, is OR'ed with
																																 ///< KINDOF_CAN_ATTACK in isAbleToAttack()
																			 OBJECT_STATUS_UNDER_CONSTRUCTION, ///< object is being constructed and is not yet
																																				 ///< complete
																			 OBJECT_STATUS_UNSELECTABLE, ///< This is a negative condition since these statuses are
																																	 ///< overrides.  ie their presence forces the condition,
																																	 ///< but their absence means nothing
																			 OBJECT_STATUS_NO_COLLISIONS, ///< object should be ignored for object-object
																																		///< collisions (but not object-ground); used for thing
																																		///< like collapsing parachutes that are intangible
																			 OBJECT_STATUS_NO_ATTACK, ///< Absolute override to being able to attack
																			 OBJECT_STATUS_AIRBORNE_TARGET, ///< InTheAir as far as AntiAir weapons are concerned
																																			///< only.
																			 OBJECT_STATUS_PARACHUTING, ///< object is on a parachute
																			 OBJECT_STATUS_REPULSOR, ///< object repulses "KINDOF_CAN_BE_REPULSED" objects.
																			 OBJECT_STATUS_HIJACKED, ///< unit is in the possesion of an enemy criminal, call the
																															 ///< authorities
																			 ...
																			 OBJECT_STATUS_IS_FIRING_WEAPON, ///< Object is firing a weapon, now. Not true for
																																			 ///< special attacks. --Lorenzen
																			 OBJECT_STATUS_BRAKING, ///< Object is braking, and subverts the physics.
																			 OBJECT_STATUS_STEALTHED, ///< Object is currently "stealthed"
																			 OBJECT_STATUS_DETECTED, ///< Object is in range of a stealth-detector unit
																															 ///< (meaningless if STEALTHED not set)
																			 OBJECT_STATUS_CAN_STEALTH, ///< Object has ability to stealth allowing the stealth
																																	///< update module to run.
																			 OBJECT_STATUS_SOLD, ///< Object is being sold
																			 OBJECT_STATUS_UNDERGOING_REPAIR, ///< Object is awaiting/undergoing a repair order
																																				///< that has been issued
																			 OBJECT_STATUS_RECONSTRUCTING, ///< Reconstructing
																			 OBJECT_STATUS_MASKED, ///< Masked objects are not selectable and targetable by players
																														 ///< or AI
																			 OBJECT_STATUS_IS_ATTACKING, ///< Object is in the general Attack state (incl. aim,
																																	 ///< approach, etc.). Note that IS_FIRING_WEAPON and
																																	 ///< IS_AIMING_WEAPON is a subset of this!
																			 OBJECT_STATUS_IS_USING_ABILITY, ///< Object is in the process of preparing or firing a
																																			 ///< special ability.
																			 OBJECT_STATUS_IS_AIMING_WEAPON, ///< Object is aiming a weapon, now. Not true for
																																			 ///< special attacks.
																			 OBJECT_STATUS_NO_ATTACK_FROM_AI, ///< attacking this object may not be done from
																																				///< commandSource == CMD_FROM_AI
																			 OBJECT_STATUS_IGNORING_STEALTH, ///< temporarily ignoring all stealth bits. (used only
																																			 ///< for some special-case mine clearing stuff.)
																			 OBJECT_STATUS_IS_CARBOMB, ///< Object is now a carbomb.
																			 OBJECT_STATUS_DECK_HEIGHT_OFFSET, ///< Object factors deck height on top of ground
																																				 ///< altitude.
																			 ...
																			 OBJECT_STATUS_MISSILE_KILLING_SELF, ///< Object (likely a missile or bomb) is
																																					 ///< *BUSTING* its way through the *BUNKER*,
																																					 ///< building or ground, awaiting death at the
																																					 ///< bottom.
																			 OBJECT_STATUS_REASSIGN_PARKING, ///< Jet is trying to get a better parking assignment.
																			 OBJECT_STATUS_BOOBY_TRAPPED, ///< We need to know we have a booby trap on us so we can
																																		///< detonate it from many different code segments
																			 ...
																			 OBJECT_STATUS_DEPLOYED, ///< Object is deployed.
																															 // add more status types here and don't forget to add to the
																															 // string table ObjectStatusMaskType::s_bitNameList[]
...
inline Bool TEST_OBJECT_STATUS_MASK_MULTI(
		const ObjectStatusMaskType &m,
		const ObjectStatusMaskType &mustBeSet,
		const ObjectStatusMaskType &mustBeClear)
{
