...
enum ObjectStatusTypes CPP_11( : Int){
    ...
    OBJECT_STATUS_UNSELECTABLE, ///< This is a negative condition since these statuses are overrides.  ie their presence
                                ///< forces the condition, but their absence means nothing
    OBJECT_STATUS_NO_COLLISIONS, ///< object should be ignored for object-object collisions (but not object-ground); used for
                                 ///< thing like collapsing parachutes that are intangible
    ...
    OBJECT_STATUS_IS_ATTACKING, ///< Object is in the general Attack state (incl. aim, approach, etc.). Note that
                                ///< IS_FIRING_WEAPON and IS_AIMING_WEAPON is a subset of this!
    ...
    OBJECT_STATUS_IGNORING_STEALTH, ///< temporarily ignoring all stealth bits. (used only for some special-case mine
                                    ///< clearing stuff.)
    ...
    OBJECT_STATUS_MISSILE_KILLING_SELF, ///< Object (likely a missile or bomb) is *BUSTING* its way through the *BUNKER*,
    ...
    OBJECT_STATUS_BOOBY_TRAPPED, ///< We need to know we have a booby trap on us so we can detonate it from many different
                                 ///< code segments
    ...
    OBJECT_STATUS_DEPLOYED, ///< Object is deployed.
                            // add more status types here and don't forget to add to the string table
