...
struct equal_to
{
	Bool operator()(const T &__t1, const T &__t2) const { return (__t1 == __t2); }
};
...
{
	Bool operator()(const AsciiString &__t1, const AsciiString &__t2) const { return (__t1 == __t2); }
};

template<>
struct less_than_nocase<AsciiString>
{
	bool operator()(const AsciiString &__t1, const AsciiString &__t2) const { return (__t1.compareNoCase(__t2) < 0); }
};

template<>
struct less_than_nocase<UnicodeString>
{
	bool operator()(const UnicodeString &__t1, const UnicodeString &__t2) const { return (__t1.compareNoCase(__t2) < 0); }
};
} // namespace rts
