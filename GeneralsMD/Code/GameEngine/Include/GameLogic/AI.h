...
public:
    ...
    UnsignedInt
        m_forceIdleFramesCount; // How many frames does a unit need to be Idle before it can begin looking for enemies?
...
enum AttitudeType CPP_11( : Int){
    ...
    ATTITUDE_INVALID = 3}; ///< AI "attitude" behavior modifiers
...
public:
    ...
    inline void aiFollowExitProductionPath(
