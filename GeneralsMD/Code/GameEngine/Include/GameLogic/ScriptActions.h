...
protected:
    ...
    void doRotateCameraTowardWaypoint(
    ...
    void doMoveCameraAlongWaypointPath(
    ...
    void doNamedFireSpecialPowerAtWaypoint(
    ...
    void doNamedUseCommandButtonAbilityOnNamed(
        const AsciiString &unit,
        const AsciiString &ability,
        const AsciiString &target);
    void doNamedUseCommandButtonAbilityAtWaypoint(
        const AsciiString &unit,
        const AsciiString &ability,
        const AsciiString &waypoint);
    void doNamedUseCommandButtonAbilityUsingWaypointPath(
        const AsciiString &unit,
        const AsciiString &ability,
        const AsciiString &waypointPath);
    void doTeamUseCommandButtonAbility(const AsciiString &team, const AsciiString &ability);
    void doTeamUseCommandButtonAbilityOnNamed(
        const AsciiString &team,
        const AsciiString &ability,
        const AsciiString &target);
    ...
    void updatePlayerRelationTowardPlayer(
        const AsciiString &playerSrcName,
        Int relationType,
        const AsciiString &playerDestPlayer);
    ...
    void doSkirmishCommandButtonOnMostValuable(
        const AsciiString &teamName,
        const AsciiString &commandButton,
        Real range,
        Bool allTeamMembers);
    ...
    void doPlayerSetScienceAvailability(
        const AsciiString &playerName,
    ...
    void doRevealMapAtWaypointPermanent(
