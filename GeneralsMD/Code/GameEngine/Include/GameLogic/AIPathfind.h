...
class ZoneBlock
{
  ...
  void blockCalculateZones(PathfindCell **map, PathfindLayer layers[],
...
class Pathfinder : PathfindServicesInterface, public Snapshot
{
  ...
  Bool slowDoesPathExist(
      ...
      ObjectID ignoreObject =
          INVALID_ID); ///< Can we build any path at all between the locations	(terrain, buildings & units check - slower)
