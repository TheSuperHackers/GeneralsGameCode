...
static const char *TheWeaponAffectsMaskNames[] =
    {"SELF", "ALLIES", "ENEMIES", "NEUTRALS", "SUICIDE", "NOT_SIMILAR", "NOT_AIRBORNE", NULL};
// #endif
...
private:
    ...
    const ParticleSystemTemplate
        *m_projectileExhausts[LEVEL_COUNT]; ///< Templates of particle systems for projectile exhaust
