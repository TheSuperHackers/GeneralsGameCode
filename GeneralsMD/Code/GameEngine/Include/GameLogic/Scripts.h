...
public:
	enum ScriptActionType
	{
		...
		NAMED_FIRE_WEAPON_FOLLOWING_WAYPOINT_PATH, ///< Fires a specific weapon that follows waypoint path and detonates at the
																							 ///< final waypoint.
		...
		SKIRMISH_FIRE_SPECIAL_POWER_AT_MOST_COST, ///< Fire a power or superweapon at the enemy's most costly concentration of
																							///< structures & units..
		...
		SKIRMISH_WAIT_FOR_COMMANDBUTTON_AVAILABLE_ALL, ///< In a sequential script, stay on this step until the specified command
																									 ///< button is ready for all units.
		...
		TEAM_ALL_USE_COMMANDBUTTON_ON_NEAREST_KINDOF, ///< Tell the team to use the commandbutton on the nearest enemy that has
																									///< kindof set
		TEAM_ALL_USE_COMMANDBUTTON_ON_NEAREST_ENEMY_BUILDING, ///< Tell the team to use the commandbutton on the nearest enemy
																													///< building
		TEAM_ALL_USE_COMMANDBUTTON_ON_NEAREST_ENEMY_BUILDING_CLASS, ///< Tell the team to use the commandbutton on the nearest
																																///< enemy building class
		TEAM_ALL_USE_COMMANDBUTTON_ON_NEAREST_OBJECTTYPE, ///< Tell the team to use the commandbutton on the nearest enemy object
																											///< of type
		...
		PLAYER_CREATE_TEAM_FROM_CAPTURED_UNITS, ///< Tell the player to create a new named team from all the units who have been
																						///< captured.
		...
		TEAM_WAIT_FOR_NOT_CONTAINED_ALL, ///< In a sequential script, stay on this step until the entire team is no longer
																		 ///< contained
		TEAM_WAIT_FOR_NOT_CONTAINED_PARTIAL, ///< In a sequential script, stay on this step until at least one member of the team
		...
		PLAYER_EXCLUDE_FROM_SCORE_SCREEN, ///< This player should be listed in the score screen.  Should only be used in campaign
																			///< games.
		...
		NAMED_SET_EVAC_LEFT_OR_RIGHT, ///< LORENZEN -- Which side of the garrisoned unit (LIKELY A TRAIN) do you want units to
																	///< evacuate from?
