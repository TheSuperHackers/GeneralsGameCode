...
enum DamageType CPP_11( : Int){
	...
	DAMAGE_SUBDUAL_MISSILE = 31, ///< Damage that does not kill you, but produces some special effect based on your Body
															 ///< Module. Seperate HP from normal damage.
...
static const char *TheDeathNames[] = {
	...
	"FLOODED", "SUICIDED", "LASERED", "DETONATED", "SPLATTED", "POISONED_BETA", "EXTRA_2",
	"EXTRA_3", "EXTRA_4",	 "EXTRA_5", "EXTRA_6",	 "EXTRA_7",	 "EXTRA_8",				"POISONED_GAMMA",
...
public:
	...
	DamageType m_damageFXOverride; ///< If not marked as the default of Unresistable, the damage type to use in doDamageFX
																 ///< instead of the real damamge type
	...
	Real m_shockWaveAmount; ///< This represents the amount of shockwave created by the damage. 0 = no shockwave, 1.0 =
													///< shockwave equal to damage.
	Real m_shockWaveRadius; ///< This represents the effect radius of the shockwave.
	Real m_shockWaveTaperOff; ///< This represents the taper off effect of the shockwave at the tip of the radius. 0.0 means
														///< shockwave is 0% at the radius edge.
