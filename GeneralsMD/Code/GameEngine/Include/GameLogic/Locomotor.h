...
public:
    ...
    */
    ...
    inline Real getForwardVelCoef() const
    {
        return m_template->m_forwardVelCoef;
    } ///< How much we pitch in response to speed.
    inline Real getLateralVelCoef() const
    {
        return m_template->m_lateralVelCoef;
...
protected:
    ...
    */
    ...
    PhysicsTurningType rotateObjAroundLocoPivot(
        Object *obj,
        const Coord3D &goalPos,
        Real maxTurnRate,
        Real *relAngle = NULL);
