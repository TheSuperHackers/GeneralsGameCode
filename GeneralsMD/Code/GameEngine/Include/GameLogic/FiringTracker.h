...
class FiringTracker : public UpdateModule
{
  ...
  */
  ...
  UnsignedInt
      m_frameToStartCooldown; ///< This is the frame I should cool down at, and is pushed back every time a shot is fired
  UnsignedInt m_frameToForceReload; ///< Even more than AutoReload, this means it will pre-emptively reload instead of
                                    ///< event triggering a delay after the last shot
