...
enum GameMode CPP_11( : Int){GAME_SINGLE_PLAYER, GAME_LAN, GAME_SKIRMISH, GAME_REPLAY, GAME_SHELL, GAME_INTERNET, GAME_NONE};
...
public:
    ...
    // Bool isLoadingGame() const { return m_loadingScene; }		// This is the old function that isn't very clear on it's
    // definition.
...
private:
    ...
    */
    ...
    //	ObjectPtrHash m_objHash;																///< Used for ObjectID
    //lookups
...
inline UnsignedShort GameLogic::getSuperweaponRestriction() const
{
