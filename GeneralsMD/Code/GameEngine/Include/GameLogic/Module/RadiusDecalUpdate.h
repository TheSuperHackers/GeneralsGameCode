...
public:
	...
	static void buildFieldParse(MultiIniFieldParse &p)
	{
		...
		static const FieldParse dataFieldParse[] = { //{ "DeliveryDecal",
																								 // RadiusDecalTemplate::parseRadiusDecalTemplate,	NULL, offsetof(
																								 // RadiusDecalUpdateModuleData, m_deliveryDecalTemplate ) }, {
																								 //"DeliveryDecalRadius",			INI::parseReal,									NULL,	offsetof(
																								 // RadiusDecalUpdateModuleData, m_deliveryDecalRadius ) },
																								 { 0, 0, 0, 0 }
		};
