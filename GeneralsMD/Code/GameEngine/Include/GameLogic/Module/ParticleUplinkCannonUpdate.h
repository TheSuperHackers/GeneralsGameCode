...
enum PUCStatus CPP_11( : Int){
	STATUS_IDLE,		STATUS_CHARGING, STATUS_PREPARING, STATUS_ALMOST_READY, STATUS_READY_TO_FIRE,
	STATUS_PREFIRE, STATUS_FIRING,	 STATUS_POSTFIRE,	 STATUS_PACKING,
};
...
public:
	...
	} // Does this object have more than one special power module with the same spTemplate?
	...
	{
		return MAKE_DISABLED_MASK4(DISABLED_SUBDUED, DISABLED_UNDERPOWERED, DISABLED_EMP, DISABLED_HACKED);
	}
