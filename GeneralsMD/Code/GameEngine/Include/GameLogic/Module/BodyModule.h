 ...
 */
//-------------------------------------------------------------------------------------------------
enum BodyDamageType CPP_11( : Int){ BODY_PRISTINE, ///< unit should appear in pristine condition
...
static const char *TheBodyDamageTypeNames[] = { "PRISTINE",
																								"DAMAGED",
																								"REALLYDAMAGED",
																								"RUBBLE",
...
public:
	...
	*/
	...
	virtual void onVeterancyLevelChanged(
			...
			Bool provideFeedback) = 0; ///< I just achieved this level right this moment
...
public:
	...
	*/
	...
	virtual void onVeterancyLevelChanged(
			VeterancyLevel oldLevel,
			VeterancyLevel newLevel,
			Bool provideFeedback = FALSE) = 0; ///< I just achieved this level right this moment
	...
	virtual void setMaxHealth(Real maxHealth, MaxHealthChangeType healthChangeType = SAME_CURRENTHEALTH) {} ///< Sets the max
																																																					///< health.
