...
public:
	...
	Real m_takeoffDistForMaxLift; ///< percent of distance from start (100%) to end (0%) that gives us max lift. Higher value
																///< lifts off sooner.
...
public:
	...
	Bool friend_isTakeoffOrLandingInProgress() const { return (getFlag(TAKEOFF_IN_PROGRESS) || getFlag(LANDING_IN_PROGRESS)); }
