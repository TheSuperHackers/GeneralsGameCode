	...
	static void buildFieldParse(MultiIniFieldParse &p)
	{
		...
		static const FieldParse dataFieldParse[] = {
			...
			{ "ImmuneToClearBuildingAttacks",
				INI::parseBool,
				NULL,
				offsetof(GarrisonContainModuleData, m_immuneToClearBuildingAttacks) },
...
public:
	...
	virtual Bool isValidContainerFor(const Object *obj, Bool checkCapacity) const; // Garrison has an extra check forbidding
																																								 // any containment if ReallyDamaged
	...
	{
		return getGarrisonContainModuleData()->m_immuneToClearBuildingAttacks;
	}
	...
	{
		return getGarrisonContainModuleData()->m_isEnclosingContainer;
	}
...
protected:
	...
	void putObjectAtBestGarrisonPoint(Object *obj, Object *target, const Coord3D *targetPos); ///< place object at position of
																																														///< the best garrison point to
																																														///< use for its target
	void putObjectAtGarrisonPoint(Object *obj, ObjectID targetID, Int conditionIndex, Int index); ///< place object at the
																																																///< specified garrison point
																																																///< index
	enum
	{
		SEARCH_FOR_REMOVE = -1
	};
	void removeObjectFromGarrisonPoint(Object *obj, Int index = SEARCH_FOR_REMOVE); ///< remove object from the garrison point
																																									///< placement
	...
	Int findClosestFreeGarrisonPointIndex(
			Int conditionIndex,
...
private:
	...
	Coord3D m_garrisonPoint[MAX_GARRISON_POINT_CONDITIONS][MAX_GARRISON_POINTS]; ///< the garrison point positions (in world
																																							 ///< coords) for pristine, damaged, and really
																																							 ///< damaged
	...
	Bool m_stationGarrisonPointsInitialized; ///< DO NOT XFER THIS!!!   TRUE once we have loaded the pre-assigned garrison
																					 ///< point positions from the art
