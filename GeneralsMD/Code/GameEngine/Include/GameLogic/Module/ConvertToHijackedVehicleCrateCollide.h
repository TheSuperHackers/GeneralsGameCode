...
public:
	...
	ConvertToHijackedVehicleCrateCollideModuleData() { m_rangeOfEffect = 0; }

	static void buildFieldParse(MultiIniFieldParse &p) { CrateCollideModuleData::buildFieldParse(p); }
};
