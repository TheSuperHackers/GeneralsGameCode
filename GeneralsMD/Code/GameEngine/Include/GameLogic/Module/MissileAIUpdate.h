...
public:
	...
	Int m_killSelfDelay; ///< If I have detonated and entered the KILL-SELF state, how ling do I wait before I Kill/destroy
											 ///< self?
...
public:
	...
	virtual void setFramesTillCountermeasureDiversionOccurs(UnsignedInt frames); ///< Number of frames till missile diverts to
																																							 ///< countermeasures.
