...
enum
{
	...
	STEALTH_NOT_WHILE_FIRING_WEAPON =
			(STEALTH_NOT_WHILE_FIRING_PRIMARY | STEALTH_NOT_WHILE_FIRING_SECONDARY | STEALTH_NOT_WHILE_FIRING_TERTIARY),
	STEALTH_NOT_WHILE_RIDERS_ATTACKING = 0x00000100,
};

#ifdef DEFINE_STEALTHLEVEL_NAMES
static const char *TheStealthLevelNames[] = {
	"ATTACKING",			 "MOVING",					"USING_ABILITY", "FIRING_PRIMARY",	 "FIRING_SECONDARY",
	"FIRING_TERTIARY", "NO_BLACK_MARKET", "TAKING_DAMAGE", "RIDERS_ATTACKING", NULL
};
#endif
...
public:
	...
	{
		return getStealthUpdateModuleData()->m_orderIdleEnemiesToAttackMeUponReveal;
	}
