...
public:
	...
	UnsignedInt m_constructionCompleteDuration; ///< in frames, how long we state in "construction complete" condition after
																							///< making something
	std::vector<QuantityModifier> m_quantityModifiers; ///< Quantity modifiers modify the number of specified object to created
																										 ///< whenever produced.
...
public:
	...
	virtual UnsignedInt countUnitTypeInQueue(const ThingTemplate *unitType) const; ///< count number of units with matching
																																								 ///< unit type in the production queue
...
protected:
	...
	const CommandButton *m_specialPowerConstructionCommandButton; ///< In a mode to construct a specific building via a special
																																///< power. (NO NEED TO SAVE DATA ON THIS FIELD)
