...
public:
	...
	Bool justLoadedFromCheckpoint() const {return m_checkpointLoadFrame > 0;}
	void clearJustLoadedFromCheckpoint() {m_checkpointLoadFrame = 0;}
	UnsignedInt getCheckpointLoadFrame() const {return m_checkpointLoadFrame;}
