...
public:
    ...
    virtual void onCapture(
        Player *oldOwner,
        Player *newOwner); // Our main guy goes with us, but our redirected contain needs to do his thing too
    ...
    virtual const Object *friend_getRider() const; ///< Damn.  The draw order dependency bug for riders means that our draw
...
private:
    ...
    */
    ...
    void activateRedirectedContain(); ///< I need to shut this off since I can talk directly to my bunker, but he can never
                                      ///< directly see me
