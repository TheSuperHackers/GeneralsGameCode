...
class ContainModuleInterface
{
  ...
  */
  ...
  virtual void orderAllPassengersToExit(
      CommandSourceType,
      Bool instantly) = 0; ///< All of the smarts of exiting are in the passenger's AIExit. removeAllFrommContain is a last
                           ///< ditch system call, this is the game Evacuate
