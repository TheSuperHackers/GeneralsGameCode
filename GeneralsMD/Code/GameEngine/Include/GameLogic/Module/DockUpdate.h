...
public:
    ...
    */
    ...
    virtual void cancelDock(
        Object *docker); ///< Clear me from any reserved points, and if I was the reason you were Busy, you aren't anymore.
    ...
    virtual UpdateSleepTime update(); ///< In charge of lifting dock restriction for one registered as Approached if all is
                                      ///< ready
...
protected:
    ...
    Bool m_dockerInside; ///< This is true while our active docker is between Enter and Exit. This is shorter than
                         ///< activeDocker's lifetime as it doesn't include approach to enter
