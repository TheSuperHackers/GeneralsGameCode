...
#define MM_SLAVED_UPDATE_RATE \
	(LOGICFRAMES_PER_SECOND / 8) ///< This is a low priority module that only needs to be called every this many frames
...
public:
	...
	UnsignedInt m_catchUpCrisisBailTime; // after this many consecutive frames outside the catchup radius, I will teleport to
																			 // the nexus
	...
	static void buildFieldParse(MultiIniFieldParse &p)
	{
		...
		static const FieldParse dataFieldParse[] = {
			...
			{ "CatchUpCrisisBailTime",
				...
				NULL,
				offsetof(MobMemberSlavedUpdateModuleData, m_catchUpCrisisBailTime) },
...
enum MobStates CPP_11( : Int){
	MOB_STATE_NONE, MOB_STATE_IDLE, MOB_STATE_CATCHUP_NOW, MOB_STATE_CATCHING_UP, MOB_STATE_ATTACK,
};
