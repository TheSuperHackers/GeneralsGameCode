...
public:
	...
	virtual void setFramesTillCountermeasureDiversionOccurs(UnsignedInt frames) = 0; ///< Number of frames till missile diverts
																																									 ///< to countermeasures.
...
public:
	...
	*/
	...
	virtual Bool action(Object *docker, Object *drone = NULL) = 0; ///< Perform your specific action on me.  Returning FALSE
																																 ///< means there is nothing for you to do so I should leave

	virtual void cancelDock(Object *docker) = 0; ///< Clear me from any reserved points, and if I was the reason you were Busy,
																							 ///< you aren't anymore.
	...
	virtual void setDockCrippled(Bool setting) = 0; ///< Game Logic can set me as inoperative.  I get to decide what that
																									///< means.
...
public:
	...
	virtual ExitDoorType reserveDoorForExit(const ThingTemplate *objType, Object *specificObject) = 0; ///< All types can
																																																		 ///< answer if they are
																																																		 ///< free to exit or
																																																		 ///< not, and you can
																																																		 ///< ask about a
																																																		 ...
																																																		 ///< just exit anything
																																																		 ///< in general
	virtual void exitObjectViaDoor(Object *newObj, ExitDoorType exitDoor) = 0; ///< Here is the object for you to exit to the
	...
	virtual void unreserveDoorForExit(ExitDoorType exitDoor) = 0; ///< if you get permission to exit, but then don't/can't call
																																///< exitObjectViaDoor, you should call this to "give up"
																																///< your permission

	virtual void exitObjectInAHurry(Object *newObj) {}; ///< Special call for objects exiting a tunnel network, does NOT change
																											///< the ai state. jba.
