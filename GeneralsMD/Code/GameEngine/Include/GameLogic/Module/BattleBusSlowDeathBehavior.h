...
class BattleBusSlowDeathBehaviorModuleData : public SlowDeathBehaviorModuleData
{
  ...
  UnsignedInt m_emptyHulkDestructionDelay; ///< Another reason this is a BattleBus module, and not a generic two stage
                                           ///< death.  If non-zero, time empty before we kill ourselves.
};
