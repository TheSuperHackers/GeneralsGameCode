    ...
    static void buildFieldParse(MultiIniFieldParse &p)
    {
        ...
        static const FieldParse dataFieldParse[] = {
            ...
            {"RepairHealthPercentPerSecond",
             ...
             NULL,
             offsetof(WorkerAIUpdateModuleData, m_repairHealthPercentPerSecond)},
            ...
            {"SupplyCenterActionDelay",
             ...
             NULL,
             offsetof(WorkerAIUpdateModuleData, m_centerDelay)},
            {"SupplyWarehouseActionDelay",
             INI::parseDurationUnsignedInt,
             NULL,
             offsetof(WorkerAIUpdateModuleData, m_warehouseDelay)},
            {"SupplyWarehouseScanDistance",
             INI::parseReal,
             NULL,
             offsetof(WorkerAIUpdateModuleData, m_warehouseScanDistance)},
            {"SuppliesDepletedVoice",
             INI::parseAudioEventRTS,
             NULL,
             offsetof(WorkerAIUpdateModuleData, m_suppliesDepletedVoice)},
...
{
public:
    virtual void exitingSupplyTruckState() = 0; ///< This worker is leaving a supply truck task and should go back to Dozer
                                                ///< mode.
};
...
public:
    ...
    virtual void cancelTask(
        DozerTask task); ///< cancel this task from the queue, if it's the current task the dozer will stop working on it
