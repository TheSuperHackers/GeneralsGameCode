...
const Int SPAWN_UPDATE_RATE = LOGICFRAMES_PER_SECOND / 2; ///< This is a low priority module that only needs to be called
	...
	static void buildFieldParse(MultiIniFieldParse &p)
	{
		...
		static const FieldParse dataFieldParse[] = {
			...
			{ "SpawnTemplateName",
				...
				NULL,
				offsetof(SpawnBehaviorModuleData, m_spawnTemplateNameData) },
			...
			{ "PropagateDamageTypesToSlavesWhenExisting",
				...
				NULL,
				offsetof(SpawnBehaviorModuleData, m_damageTypesToPropagateToSlaves) },
...
public:
	...
	virtual CanAttackResult getCanAnySlavesAttackSpecificTarget(
			AbleToAttackType attackType,
			const Object *target,
			CommandSourceType cmdSource) = 0;
...
public:
	...
	virtual void onSpawnDeath(ObjectID deadSpawn, DamageInfo *damageInfo); ///< Something we spawned and set up to tell us it
																																				 ///< died just died.
