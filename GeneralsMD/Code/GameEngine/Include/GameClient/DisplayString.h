...
public:
	...
	virtual void draw(Int x, Int y, Color color, Color dropColor, Int xDrop, Int yDrop) = 0; ///< render text with the drop
																																													 ///< shadow being at the offsets
																																													 ///< passed in
	...
	virtual void truncateTo(const Int maxLength); ///< remove characters, if needed, until the string is maxLength long
...
// INLINING ///////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
inline UnicodeString DisplayString::getText(void)
{
	return m_textString;
}
inline Int DisplayString::getTextLength(void)
{
	return m_textString.getLength();
}
inline void DisplayString::setFont(GameFont *font)
{
	m_font = font;
}
inline GameFont *DisplayString::getFont(void)
{
	return m_font;
}
...
inline DisplayString *DisplayString::next(void)
{
	return m_next;
}
