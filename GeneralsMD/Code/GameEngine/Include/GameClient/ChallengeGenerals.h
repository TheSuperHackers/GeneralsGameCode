...
public:
	GeneralPersona(void) : m_imageBioPortraitSmall(NULL), m_imageBioPortraitLarge(NULL) {}
	//	~GeneralPersona( void );
	...
	const AsciiString &getPlayerTemplateName() const
	{
		return m_strPlayerTemplateName;
	} // template name, as parsed in from ini
