...
enum ParticlePriorityType CPP_11( : Int){
	...
	ALWAYS_RENDER, ///< used for logically important display (not just fluff), so must never be culled, regardless of particle
								 ///< cap, lod, etc
...
protected:
	...
	const ParticleInfo *generateParticleInfo(Int particleNum, Int particleCount); ///< generate a new, random set of
																																								///< ParticleInfo
