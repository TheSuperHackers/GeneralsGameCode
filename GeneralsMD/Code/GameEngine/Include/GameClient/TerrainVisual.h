...
public:
	...
	virtual SeismicSimStatusCode filterCallback(
			WorldHeightMapInterfaceClass *heightMap,
			const SeismicSimulationNode *node) = 0;
...
static const char *TerrainLODNames[] = { "NONE",				"MIN",			 "STRETCH_NO_CLOUDS",
																				 "HALF_CLOUDS", "NO_CLOUDS", "STRETCH_CLOUDS",
																				 "NO_WATER",		"MAX",			 "AUTOMATIC",
																				 "DISABLE",
...
public:
	...
	virtual Bool intersectTerrain(Coord3D *rayStart, Coord3D *rayEnd, Coord3D *result) { return FALSE; }
	...
	virtual void replaceSkyboxTextures(
			...
			const AsciiString *newTexName[NumSkyboxTextures]) = 0;
