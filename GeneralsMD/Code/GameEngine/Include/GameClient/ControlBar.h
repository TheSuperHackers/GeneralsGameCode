...
protected:
    ...
    // GameWindow *m_commandMarkers[ MAX_COMMANDS_PER_SET ];			///< When we don't have a command, they want to show
    // an image
    // removed from multiplayer branch
    // void showCommandMarkers( void );													///< function that compare's what's
    // being shown in m_commandWindows and shows the ones that are hidden.
