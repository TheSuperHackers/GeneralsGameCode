...
public:
    ...
    void push(
        ...
        Bool shutdownImmediate = FALSE); ///< load new screen on top, optionally doing an immediate shutdown
    ...
    WindowLayout *getOptionsLayout(
        Bool create); ///< return layout for options menu, create if necessary and we are allowed to.
