...
{
	CursorCaptureMode_None = 0, // Does not capture the cursor
	CursorCaptureMode_InGame = 1, // Captures the cursor when playing and observing
	CursorCaptureMode_Always = 2, // Captures the cursor always in menus and game
	CursorCaptureMode_Auto = 3, // Applies mode "InGame" when Windowed, "Always" when Fullscreen
