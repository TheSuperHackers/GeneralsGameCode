...
enum CursorCaptureMode CPP_11( : Int){
	...
	CursorCaptureMode_Count,	CursorCaptureMode_Default = CursorCaptureMode_Auto,
};
...
public:
	...
	void setCursorTooltip(
			...
			Real width = 1.0f); ///< set tooltip string at cursor
	void setMouseText(UnicodeString text, const RGBAColorInt *color, const RGBAColorInt *dropColor); ///< set the cursor text,
																																																	 ///< *NOT* the tooltip
																																																	 ///< text
