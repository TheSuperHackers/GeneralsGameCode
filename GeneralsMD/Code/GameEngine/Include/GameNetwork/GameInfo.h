...
enum SlotState CPP_11( : Int){ SLOT_OPEN, SLOT_CLOSED, SLOT_EASY_AI, SLOT_MED_AI, SLOT_BRUTAL_AI, SLOT_PLAYER };
...
public:
	...
	Int getSlotNum(AsciiString userName) const; ///< Get the slot number corresponding to a specific user, or -1 if he's not
																							///< present
	...
	virtual void adjustSlotsForMap(void); ///< adjusts the slots to open and closed depending on the players in the game and
																				///< the number of players the map can hold.
