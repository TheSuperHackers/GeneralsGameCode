...
void GSMessageBoxOk(
    ...
    GameWinMsgBoxFunc okFunc = NULL); ///< Display a Message box with Ok button and track it
...
void RaiseGSMessageBox(
    void); ///< Bring GS message box to the foreground (if we transition screens while a message box is up)
