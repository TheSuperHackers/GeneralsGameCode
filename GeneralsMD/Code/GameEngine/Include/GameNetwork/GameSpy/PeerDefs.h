...
enum GameSpyColors CPP_11( : Int){ GSCOLOR_DEFAULT = 0,
																	 GSCOLOR_CURRENTROOM,
																	 GSCOLOR_ROOM,
																	 GSCOLOR_GAME,
																	 GSCOLOR_GAME_FULL,
...
enum GameSpyBuddyStatus CPP_11( : Int){ BUDDY_OFFLINE, BUDDY_ONLINE,	BUDDY_LOBBY,		BUDDY_STAGING,
																				BUDDY_LOADING, BUDDY_PLAYING, BUDDY_MATCHING, BUDDY_MAX };
