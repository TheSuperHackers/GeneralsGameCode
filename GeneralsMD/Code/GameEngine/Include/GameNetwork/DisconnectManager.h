...
class DisconnectManager
{
  ...
  Bool isLocalPlayerNextPacketRouter(
      ConnectionManager *conMgr); ///< returns true if the local player is next in line to be the packet router with all
                                  ///< the players that have timed out being taken out of the picture.
  ...
  Bool isPlayerInGame(
      Int slot,
      ConnectionManager *conMgr); ///< returns true if the player has neither timed out or been voted out.
