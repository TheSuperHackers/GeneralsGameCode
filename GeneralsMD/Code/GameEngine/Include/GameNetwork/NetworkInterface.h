...
public:
    ...
    virtual void setLocalAddress(
        UnsignedInt ip,
        UnsignedInt port) = 0; ///< Tell the network what local ip and port to bind to.
    ...
    virtual UnsignedInt getPacketArrivalCushion(
        void) = 0; ///< Get the smallest packet arrival cushion since this was last called.
