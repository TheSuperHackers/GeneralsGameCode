...
#define PBT_APMRESUMESUSPEND 0x0007
			...
			case WM_SYSCOMMAND:
				...
				{
					case SC_KEYMENU:
						// TheSuperHackers @bugfix Mauller 10/05/2025 Always handle this command to prevent halting the game when left
						// Alt is pressed.
						return 1;
					case SC_MOVE:
					case SC_SIZE:
...
static Bool initializeAppWindows(HINSTANCE hInstance, Int nCmdShow, Bool runWindowed)
{
	...
	WNDCLASS wndClass = { CS_HREDRAW | CS_VREDRAW | CS_DBLCLKS,
												WndProc,
												0,
												0,
												hInstance,
